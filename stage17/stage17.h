#ifndef MI4IOS6_STAGE17_H
#define MI4IOS6_STAGE17_H

#include <stdint.h>
#include <stddef.h>

#define STAGE17_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage17;
...
extern struct gic_state_snapshot GIC_state_stage17;
extern volatile uint32_t stage17_irq_count;
extern volatile uint32_t stage17_last_iar;
extern volatile uint32_t stage17_last_irq_id;
extern volatile uint32_t stage17_timer_irq_count;
extern volatile uint32_t stage17_last_timer_irq_id;
...
/* stage17_main.c */
void stage17_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage17_image_end[];
extern uint8_t stage17_vectors[];
void trigger_stage17_undef_test(void) __attribute__((noreturn));
void trigger_stage17_data_abort_test(void) __attribute__((noreturn));
