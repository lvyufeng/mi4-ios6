...
static struct stage87_gic_irq_state {
...
void stage87_gic_irq_init(void)
{
	...
	*gicc_pmr = 0xff;
	...
	g_gic_irq_state.init_status = STAGE87_STATUS_OK;
}

void stage87_gic_irq_enable_interrupt(uint32_t irq_id)
{
...
const struct stage87_gic_irq_state *stage87_gic_irq_state(void)
{
