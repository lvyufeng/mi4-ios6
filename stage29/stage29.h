#ifndef MI4IOS6_STAGE29_H
#define MI4IOS6_STAGE29_H

#include <stdint.h>
#include <stddef.h>

#define STAGE29_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage29;
...
extern struct gic_state_snapshot GIC_state_stage29;
extern volatile uint32_t stage29_irq_count;
extern volatile uint32_t stage29_last_iar;
extern volatile uint32_t stage29_last_irq_id;
extern volatile uint32_t stage29_timer_irq_count;
extern volatile uint32_t stage29_last_timer_irq_id;
...
/* stage29_main.c */
void stage29_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage29_image_end[];
extern uint8_t stage29_vectors[];
void trigger_stage29_undef_test(void) __attribute__((noreturn));
void trigger_stage29_data_abort_test(void) __attribute__((noreturn));
