#ifndef MI4IOS6_STAGE7_H
#define MI4IOS6_STAGE7_H

#include <stdint.h>
#include <stddef.h>

#define STAGE7_BASE          0x00008000u
...
extern struct gic_state_snapshot GIC_state_stage7;
...
/* stage7_main.c */
void stage7_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage7_image_end[];
extern uint8_t stage7_vectors[];
void trigger_stage7_undef_test(void) __attribute__((noreturn));
void trigger_stage7_data_abort_test(void) __attribute__((noreturn));
