#ifndef MI4IOS6_STAGE40_H
#define MI4IOS6_STAGE40_H

#include <stdint.h>
#include <stddef.h>

#define STAGE40_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage40;
...
extern struct gic_state_snapshot GIC_state_stage40;
extern volatile uint32_t stage40_irq_count;
extern volatile uint32_t stage40_last_iar;
extern volatile uint32_t stage40_last_irq_id;
extern volatile uint32_t stage40_timer_irq_count;
extern volatile uint32_t stage40_last_timer_irq_id;
...
/* stage40_main.c */
void stage40_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage40_image_end[];
extern uint8_t stage40_vectors[];
void trigger_stage40_undef_test(void) __attribute__((noreturn));
void trigger_stage40_data_abort_test(void) __attribute__((noreturn));
