#ifndef MI4IOS6_STAGE61_SHIM_PEXPERT_BOOT_H
#define MI4IOS6_STAGE61_SHIM_PEXPERT_BOOT_H

#include <stdint.h>

/*
 * Stage61 compile-only public ARM pexpert boot_args shim.
 *
 * The selected Darwin 12 / xnu-2050 public tree lacks a complete ARMv7
 * pexpert/arm boot header. Stage61 uses the public xnu-4570 ARM pexpert
 * shape as an ABI reference for host-only compile/link proof, but the bootable
 * Stage61 payload continues to use its own stage61.h boot_args structure and
