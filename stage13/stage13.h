#ifndef MI4IOS6_STAGE13_H
#define MI4IOS6_STAGE13_H

#include <stdint.h>
#include <stddef.h>

#define STAGE13_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage13;
...
extern struct gic_state_snapshot GIC_state_stage13;
extern volatile uint32_t stage13_irq_count;
extern volatile uint32_t stage13_last_iar;
extern volatile uint32_t stage13_last_irq_id;
extern volatile uint32_t stage13_timer_irq_count;
extern volatile uint32_t stage13_last_timer_irq_id;
...
/* stage13_main.c */
void stage13_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage13_image_end[];
extern uint8_t stage13_vectors[];
void trigger_stage13_undef_test(void) __attribute__((noreturn));
void trigger_stage13_data_abort_test(void) __attribute__((noreturn));
