#ifndef MI4IOS6_STAGE28_H
#define MI4IOS6_STAGE28_H

#include <stdint.h>
#include <stddef.h>

#define STAGE28_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage28;
...
extern struct gic_state_snapshot GIC_state_stage28;
extern volatile uint32_t stage28_irq_count;
extern volatile uint32_t stage28_last_iar;
extern volatile uint32_t stage28_last_irq_id;
extern volatile uint32_t stage28_timer_irq_count;
extern volatile uint32_t stage28_last_timer_irq_id;
...
/* stage28_main.c */
void stage28_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage28_image_end[];
extern uint8_t stage28_vectors[];
void trigger_stage28_undef_test(void) __attribute__((noreturn));
void trigger_stage28_data_abort_test(void) __attribute__((noreturn));
