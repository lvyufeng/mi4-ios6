#ifndef MI4IOS6_STAGE22_H
#define MI4IOS6_STAGE22_H

#include <stdint.h>
#include <stddef.h>

#define STAGE22_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage22;
...
extern struct gic_state_snapshot GIC_state_stage22;
extern volatile uint32_t stage22_irq_count;
extern volatile uint32_t stage22_last_iar;
extern volatile uint32_t stage22_last_irq_id;
extern volatile uint32_t stage22_timer_irq_count;
extern volatile uint32_t stage22_last_timer_irq_id;
...
/* stage22_main.c */
void stage22_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage22_image_end[];
extern uint8_t stage22_vectors[];
void trigger_stage22_undef_test(void) __attribute__((noreturn));
void trigger_stage22_data_abort_test(void) __attribute__((noreturn));
