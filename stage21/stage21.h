#ifndef MI4IOS6_STAGE21_H
#define MI4IOS6_STAGE21_H

#include <stdint.h>
#include <stddef.h>

#define STAGE21_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage21;
...
extern struct gic_state_snapshot GIC_state_stage21;
extern volatile uint32_t stage21_irq_count;
extern volatile uint32_t stage21_last_iar;
extern volatile uint32_t stage21_last_irq_id;
extern volatile uint32_t stage21_timer_irq_count;
extern volatile uint32_t stage21_last_timer_irq_id;
...
/* stage21_main.c */
void stage21_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage21_image_end[];
extern uint8_t stage21_vectors[];
void trigger_stage21_undef_test(void) __attribute__((noreturn));
void trigger_stage21_data_abort_test(void) __attribute__((noreturn));
