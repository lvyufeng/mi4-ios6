#ifndef MI4IOS6_STAGE33_H
#define MI4IOS6_STAGE33_H

#include <stdint.h>
#include <stddef.h>

#define STAGE33_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage33;
...
extern struct gic_state_snapshot GIC_state_stage33;
extern volatile uint32_t stage33_irq_count;
extern volatile uint32_t stage33_last_iar;
extern volatile uint32_t stage33_last_irq_id;
extern volatile uint32_t stage33_timer_irq_count;
extern volatile uint32_t stage33_last_timer_irq_id;
...
/* stage33_main.c */
void stage33_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage33_image_end[];
extern uint8_t stage33_vectors[];
void trigger_stage33_undef_test(void) __attribute__((noreturn));
void trigger_stage33_data_abort_test(void) __attribute__((noreturn));
