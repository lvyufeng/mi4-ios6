#ifndef MI4IOS6_STAGE23_H
#define MI4IOS6_STAGE23_H

#include <stdint.h>
#include <stddef.h>

#define STAGE23_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage23;
...
extern struct gic_state_snapshot GIC_state_stage23;
extern volatile uint32_t stage23_irq_count;
extern volatile uint32_t stage23_last_iar;
extern volatile uint32_t stage23_last_irq_id;
extern volatile uint32_t stage23_timer_irq_count;
extern volatile uint32_t stage23_last_timer_irq_id;
...
/* stage23_main.c */
void stage23_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage23_image_end[];
extern uint8_t stage23_vectors[];
void trigger_stage23_undef_test(void) __attribute__((noreturn));
void trigger_stage23_data_abort_test(void) __attribute__((noreturn));
