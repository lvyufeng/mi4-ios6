#ifndef MI4IOS6_STAGE20_H
#define MI4IOS6_STAGE20_H

#include <stdint.h>
#include <stddef.h>

#define STAGE20_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage20;
...
extern struct gic_state_snapshot GIC_state_stage20;
extern volatile uint32_t stage20_irq_count;
extern volatile uint32_t stage20_last_iar;
extern volatile uint32_t stage20_last_irq_id;
extern volatile uint32_t stage20_timer_irq_count;
extern volatile uint32_t stage20_last_timer_irq_id;
...
/* stage20_main.c */
void stage20_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage20_image_end[];
extern uint8_t stage20_vectors[];
void trigger_stage20_undef_test(void) __attribute__((noreturn));
void trigger_stage20_data_abort_test(void) __attribute__((noreturn));
