...
static struct stage72_xnu_iokit_provider_plane_dryrun_contract g_stage72_xnu_iokit_provider_plane_dryrun_contract;

static uint32_t stage72_iokit_provider_plane_dryrun_checksum(
    volatile const struct stage72_xnu_iokit_provider_plane_dryrun_contract *contract)
{
    volatile const uint32_t *words = (volatile const uint32_t *)(uintptr_t)contract;
    uint32_t count = (uint32_t)(offsetof(struct stage72_xnu_iokit_provider_plane_dryrun_contract, checksum) /
                                sizeof(uint32_t));
...
static void stage72_iokit_provider_plane_dryrun_log(
    const struct stage72_xnu_iokit_provider_plane_dryrun_contract *contract)
{
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_dryrun_contract_status", contract->status);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_dryrun_contract_required_mask", contract->required_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_dryrun_contract_satisfied_mask", contract->satisfied_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_dryrun_contract_failure_mask", contract->failure_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_dryrun_contract_checksum", contract->checksum);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_source_registry_status", contract->source_registry_status);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_source_registry_satisfied_mask", contract->source_registry_satisfied_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_apple_dt_semantic_mask", contract->apple_dt_semantic_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_registry_root_props", contract->registry_root_prop_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_platform_props", contract->platform_driver_prop_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_interrupt_props", contract->interrupt_service_prop_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_timer_props", contract->timer_service_prop_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_cpu_props", contract->cpu_service_prop_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_rejected_props", contract->rejected_driver_prop_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_parent_match_mask", contract->provider_parent_match_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_dependency_mask", contract->provider_dependency_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_publish_order_mask", contract->provider_publish_order_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_published_service_mask", contract->provider_published_service_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_unpublished_service_mask", contract->provider_unpublished_service_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_matrix", contract->provider_plane_matrix);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_service_fact_mask", contract->service_fact_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_root_publish_ordinal", contract->root_publish_ordinal);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_platform_publish_ordinal", contract->platform_publish_ordinal);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_interrupt_publish_ordinal", contract->interrupt_publish_ordinal);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_timer_publish_ordinal", contract->timer_publish_ordinal);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_cpu_publish_ordinal", contract->cpu_publish_ordinal);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_rejected_publish_ordinal", contract->rejected_publish_ordinal);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_publish_order_checksum", contract->publish_order_checksum);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_provider_candidate_count", contract->provider_candidate_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_service_candidate_count", contract->service_candidate_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_published_service_count", contract->published_service_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_unpublished_candidate_count", contract->unpublished_candidate_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_dryrun_publish_count", contract->dryrun_publish_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_provider_plane_count", contract->provider_plane_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_registry_plane_count", contract->registry_plane_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_attach_deferred_count", contract->attach_deferred_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_start_deferred_count", contract->start_deferred_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_iokit_reference_mask", contract->iokit_reference_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_iokit_runtime_blocked_mask", contract->iokit_runtime_blocked_mask);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_public_compile_count", contract->iokit_public_compile_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_public_link_count", contract->iokit_public_link_count);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_no_iokit_runtime_exec", contract->no_iokit_runtime_exec);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_no_provider_runtime_exec", contract->no_provider_runtime_exec);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_no_platform_driver_exec", contract->no_platform_driver_exec);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_no_live_pmap_tables_installed", contract->no_live_pmap_tables_installed);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_proposed_workspace_written", contract->proposed_workspace_written);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_pmap_ttbr_written", contract->pmap_ttbr_written);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_pmap_tlbs_invalidated", contract->pmap_tlbs_invalidated);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_caches_changed", contract->caches_changed);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_persistent_write_attempted", contract->persistent_write_attempted);
    xnu_log_kv32("stage72_xnu_iokit_provider_plane_platform_gap_mask", contract->proposed_platform_gap_mask);
}

int stage72_xnu_iokit_provider_plane_dryrun_contract_selftest(
    const struct stage72_loader_preflight *preflight)
{
    struct stage72_xnu_iokit_provider_plane_dryrun_contract *contract =
        &g_stage72_xnu_iokit_provider_plane_dryrun_contract;
    ...
    contract->version = STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_CONTRACT_VERSION;
    contract->size = sizeof(*contract);
    contract->status = STAGE72_STATUS_BASE;
    contract->required_mask = STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_REQUIRED_MASK;

    if (!preflight || !args || !root) {
        contract->failure_mask = STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_SOURCE |
            STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_SAFETY_BOUNDARY;
        contract->checksum = stage72_iokit_provider_plane_dryrun_checksum(contract);
        stage72_iokit_provider_plane_dryrun_log(contract);
        return 0;
    }
    ...
    if (string_prop_equals(args, platform_node, "IOProviderClass", "IOPlatformExpertDevice")) {
        contract->provider_parent_match_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (string_prop_equals(args, interrupt_node, "IOProviderClass", "IOPlatformExpertDevice")) {
        contract->provider_parent_match_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (string_prop_equals(args, timer_node, "IOProviderClass", "IOPlatformExpertDevice")) {
        contract->provider_parent_match_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (string_prop_equals(args, cpu_node, "IOProviderClass", "IOPlatformExpertDevice")) {
        contract->provider_parent_match_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT;
    }
    ...
    if (prop_present(args, rejected_node, "rejected-candidate") == 1u &&
        ...
        contract->provider_unpublished_service_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    contract->provider_plane_matrix = contract->provider_published_service_mask |
        contract->provider_unpublished_service_mask;

    contract->root_publish_ordinal = STAGE72_XNU_IOKIT_PROVIDER_PLANE_ROOT_ORDINAL;
    contract->platform_publish_ordinal = STAGE72_XNU_IOKIT_PROVIDER_PLANE_PLATFORM_ORDINAL;
    contract->interrupt_publish_ordinal = STAGE72_XNU_IOKIT_PROVIDER_PLANE_INTERRUPT_ORDINAL;
    contract->timer_publish_ordinal = STAGE72_XNU_IOKIT_PROVIDER_PLANE_TIMER_ORDINAL;
    contract->cpu_publish_ordinal = STAGE72_XNU_IOKIT_PROVIDER_PLANE_CPU_ORDINAL;
    contract->rejected_publish_ordinal = STAGE72_XNU_IOKIT_PROVIDER_PLANE_REJECTED_ORDINAL;
    if (contract->root_publish_ordinal == 0u) {
        contract->provider_publish_order_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (contract->platform_publish_ordinal < contract->interrupt_publish_ordinal) {
        contract->provider_publish_order_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (contract->interrupt_publish_ordinal < contract->timer_publish_ordinal) {
        contract->provider_publish_order_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (contract->timer_publish_ordinal < contract->cpu_publish_ordinal) {
        contract->provider_publish_order_mask |= STAGE72_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT;
    }
    ...
    contract->provider_candidate_count = STAGE72_XNU_IOKIT_PROVIDER_PLANE_PROVIDER_COUNT;
    contract->service_candidate_count = STAGE72_XNU_IOKIT_PROVIDER_PLANE_SERVICE_CANDIDATE_COUNT;
    contract->published_service_count = (contract->provider_published_service_mask ==
        ...
        STAGE72_XNU_IOKIT_PROVIDER_PLANE_PUBLISHED_COUNT : 0u;
    contract->unpublished_candidate_count = (contract->provider_unpublished_service_mask ==
        ...
        STAGE72_XNU_IOKIT_PROVIDER_PLANE_REJECTED_COUNT : 0u;
    ...
    source_ok = (contract->source_registry_status == STAGE72_STATUS_OK &&
    ...
    if (source_ok) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_SOURCE_REGISTRY;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_SOURCE;
    }

    if (contract->apple_dt_semantic_mask == STAGE72_DT_READY_REQUIRED) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_APPLE_DT;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_DT;
    }
    ...
    if (contract->registry_root_node_ptr != 0u && contract->registry_root_prop_count >= 6u &&
        ...
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_PROVIDER_ROOT;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PROVIDER;
    }
    ...
    if (service_nodes_ok) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_SERVICE_NODE_SET;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PROVIDER;
    }

    if (contract->provider_parent_match_mask == STAGE72_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_PARENT_MATRIX;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PROVIDER;
    }
    if (contract->provider_publish_order_mask == STAGE72_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->publish_order_checksum == 0xfffffffbu) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_PUBLISH_ORDER;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PUBLISH;
    }
    if (contract->provider_dependency_mask == STAGE72_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_DEPENDENCY_MATRIX;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_DEPENDENCY;
    }
    if (contract->service_fact_mask == STAGE72_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_SERVICE_FACTS;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_FACTS;
    }
    if (contract->provider_unpublished_service_mask == STAGE72_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->unpublished_candidate_count == STAGE72_XNU_IOKIT_PROVIDER_PLANE_REJECTED_COUNT &&
        contract->rejected_publish_ordinal == STAGE72_XNU_IOKIT_PROVIDER_PLANE_REJECTED_ORDINAL) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_REJECT_UNPUBLISHED;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PUBLISH;
    }
    if (contract->provider_candidate_count == STAGE72_XNU_IOKIT_PROVIDER_PLANE_PROVIDER_COUNT &&
        contract->service_candidate_count == STAGE72_XNU_IOKIT_PROVIDER_PLANE_SERVICE_CANDIDATE_COUNT &&
        contract->published_service_count == STAGE72_XNU_IOKIT_PROVIDER_PLANE_PUBLISHED_COUNT &&
        contract->unpublished_candidate_count == STAGE72_XNU_IOKIT_PROVIDER_PLANE_REJECTED_COUNT &&
        contract->dryrun_publish_count == STAGE72_XNU_IOKIT_PROVIDER_PLANE_PUBLISHED_COUNT &&
        contract->provider_plane_matrix == (STAGE72_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                            STAGE72_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_DRYRUN_COUNTS;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PUBLISH;
    }

    if (contract->attach_deferred == 1u && contract->start_deferred == 1u &&
        contract->attach_deferred_count == STAGE72_XNU_IOKIT_PROVIDER_PLANE_PUBLISHED_COUNT &&
        contract->start_deferred_count == STAGE72_XNU_IOKIT_PROVIDER_PLANE_PUBLISHED_COUNT) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_ATTACH_START_DEFERRED;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    ...
    if (contract->iokit_reference_mask == STAGE72_XNU_IOKIT_REFERENCE_REQUIRED &&
        ...
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_IOKIT_REFERENCE;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    ...
    if (public_boundary_ok) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_PUBLIC_BOUNDARY |
            STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_IOKIT_RUNTIME_EXEC |
            STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_PROVIDER_RUNTIME_EXEC |
            STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_PLATFORM_DRIVER_EXEC |
            STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_PUBLIC_XNU_EXEC;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }

    if (contract->no_public_pmap_exec == 1u) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_PUBLIC_PMAP_EXEC;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PMAP_BOUNDARY;
    }
    ...
    if (contract->no_live_pmap_tables_installed == 0u) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_LIVE_PMAP_INSTALL;
    }
    if (contract->proposed_workspace_written == 0u) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_PROPOSED_PMAP_WRITE;
    }
    if (contract->pmap_ttbr_written == 0u && contract->pmap_ttbcr_written == 0u &&
        contract->pmap_dacr_written == 0u && contract->pmap_sctlr_written == 0u) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_PMAP_CONTROL_WRITE;
    }
    if (contract->pmap_tlbs_invalidated == 0u && contract->caches_changed == 0u) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_TLB_CACHE_CHANGE;
    }
    if (pmap_boundary_ok && contract->source_pmap_transition_status == STAGE72_STATUS_OK &&
        contract->source_pmap_transition_failure_mask == 0u) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_PMAP_BOUNDARY;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_PMAP_BOUNDARY;
    }

    if (contract->xnu_start_executed == 0u && contract->generated_macho_executed == 0u) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_XNU_MACHO_EXEC;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->persistent_write_attempted == 0u) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_NO_PERSIST_WRITE;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    ...
    if (contract->proposed_platform_gap_mask == (STAGE72_PLATFORM_GAP_REQUIRED_RECORDED &
        ...
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_PLATFORM_ROLLUP;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_ROLLUP;
    }

    if (contract->local_only == 1u && contract->fail_closed == 1u &&
        contract->provider_published_service_mask == STAGE72_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->provider_unpublished_service_mask == STAGE72_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_SAT_FAIL_CLOSED;
    } else {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    contract->checksum = stage72_iokit_provider_plane_dryrun_checksum(contract);
    if (contract->checksum != stage72_iokit_provider_plane_dryrun_checksum(contract)) {
        contract->failure_mask |= STAGE72_XNU_IOKIT_PROVIDER_PLANE_DRYRUN_FAIL_CHECKSUM;
    }
...
const struct stage72_xnu_iokit_provider_plane_dryrun_contract *
stage72_xnu_iokit_provider_plane_dryrun_contract_result(void)
{
    return &g_stage72_xnu_iokit_provider_plane_dryrun_contract;
}
