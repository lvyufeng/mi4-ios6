#ifndef MI4IOS6_STAGE27_H
#define MI4IOS6_STAGE27_H

#include <stdint.h>
#include <stddef.h>

#define STAGE27_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage27;
...
extern struct gic_state_snapshot GIC_state_stage27;
extern volatile uint32_t stage27_irq_count;
extern volatile uint32_t stage27_last_iar;
extern volatile uint32_t stage27_last_irq_id;
extern volatile uint32_t stage27_timer_irq_count;
extern volatile uint32_t stage27_last_timer_irq_id;
...
/* stage27_main.c */
void stage27_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage27_image_end[];
extern uint8_t stage27_vectors[];
void trigger_stage27_undef_test(void) __attribute__((noreturn));
void trigger_stage27_data_abort_test(void) __attribute__((noreturn));
