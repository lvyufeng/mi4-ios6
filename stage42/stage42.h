#ifndef MI4IOS6_STAGE42_H
#define MI4IOS6_STAGE42_H

#include <stdint.h>
#include <stddef.h>

#define STAGE42_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage42;
...
extern struct gic_state_snapshot GIC_state_stage42;
extern volatile uint32_t stage42_irq_count;
extern volatile uint32_t stage42_last_iar;
extern volatile uint32_t stage42_last_irq_id;
extern volatile uint32_t stage42_timer_irq_count;
extern volatile uint32_t stage42_last_timer_irq_id;
...
/* stage42_main.c */
void stage42_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage42_image_end[];
extern uint8_t stage42_vectors[];
void trigger_stage42_undef_test(void) __attribute__((noreturn));
void trigger_stage42_data_abort_test(void) __attribute__((noreturn));
