...
static struct stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract
    g_stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract;

static uint32_t stage86_iokit_client_open_provider_claim_close_dryrun_checksum(
    volatile const struct stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract *contract)
{
    volatile const uint32_t *words = (volatile const uint32_t *)(uintptr_t)contract;
    uint32_t count = (uint32_t)(offsetof(struct stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract,
...
static void selected_masks_for_node(const struct boot_args *args, const void *node, uint32_t bit,
                                    ...
                                    uint32_t order,
                                    struct stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract *contract)
{
    ...
    if (string_prop_equals(args, node, "open-provenance", "stage86-provider-callback")) {
        contract->open_provenance_match_mask |= bit;
    }
}

static void stage86_iokit_client_open_provider_claim_close_dryrun_log(
    const struct stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract *contract)
{
    xnu_log_kv32("stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract_status", contract->status);
    xnu_log_kv32("stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract_required_mask", contract->required_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract_satisfied_mask", contract->satisfied_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract_failure_mask", contract->failure_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract_checksum", contract->checksum);
    xnu_log_kv32("stage86_xnu_iokit_client_open_source_status", contract->source_provider_callback_status);
    xnu_log_kv32("stage86_xnu_iokit_client_open_source_satisfied_mask", contract->source_provider_callback_satisfied_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_source_failure_mask", contract->source_provider_callback_failure_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_source_checksum", contract->source_provider_callback_checksum);
    xnu_log_kv32("stage86_xnu_iokit_client_open_source_selected_provider_callback_entry_mask", contract->source_selected_provider_callback_entry_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_source_rejected_provider_callback_mask", contract->source_rejected_provider_callback_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_source_provider_callback_matrix", contract->source_provider_callback_matrix);
    xnu_log_kv32("stage86_xnu_iokit_client_open_source_client_ack_mask_match_mask", contract->source_client_ack_mask_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_apple_dt_semantic_mask", contract->apple_dt_semantic_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_platform_props", contract->platform_personality_prop_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_interrupt_props", contract->interrupt_personality_prop_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_timer_props", contract->timer_personality_prop_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_cpu_props", contract->cpu_personality_prop_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_rejected_props", contract->rejected_personality_prop_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_ready_mask", contract->client_open_ready_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_provider_claim_ready_mask", contract->provider_claim_ready_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_client_close_ready_mask", contract->client_close_ready_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_provider_path_match_mask", contract->open_provider_path_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_provider_ordinal_match_mask", contract->open_provider_ordinal_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_type_match_mask", contract->open_type_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_expected_open_mask_match_mask", contract->expected_open_mask_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_claimed_open_mask_match_mask", contract->claimed_open_mask_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_client_close_mask_match_mask", contract->client_close_mask_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_dependency_ready_mask", contract->open_dependency_ready_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_runtime_blocked_mask", contract->open_runtime_blocked_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_claim_runtime_blocked_mask", contract->provider_claim_runtime_blocked_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_close_runtime_blocked_mask", contract->client_close_runtime_blocked_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_order_match_mask", contract->open_order_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_close_order_match_mask", contract->close_order_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_provenance_match_mask", contract->open_provenance_match_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_selected_client_open_entry_mask", contract->selected_client_open_entry_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_rejected_client_open_mask", contract->rejected_client_open_mask);
    xnu_log_kv32("stage86_xnu_iokit_client_open_matrix", contract->client_open_provider_claim_close_matrix);
    xnu_log_kv32("stage86_xnu_iokit_client_open_open_order_checksum", contract->open_order_checksum);
    xnu_log_kv32("stage86_xnu_iokit_client_open_close_order_checksum", contract->close_order_checksum);
    xnu_log_kv32("stage86_xnu_iokit_client_open_mask_checksum", contract->client_open_mask_checksum);
    xnu_log_kv32("stage86_xnu_iokit_client_open_path_hash", contract->client_open_path_hash);
    xnu_log_kv32("stage86_xnu_iokit_client_open_checksum", contract->client_open_checksum);
    xnu_log_kv32("stage86_xnu_iokit_client_open_expected_checksum", contract->expected_client_open_checksum);
    xnu_log_kv32("stage86_xnu_iokit_client_open_candidate_count", contract->client_open_candidate_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_selected_entry_count", contract->selected_client_open_entry_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_rejected_entry_count", contract->rejected_client_open_entry_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_open_ready_count", contract->client_open_ready_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_claim_ready_count", contract->provider_claim_ready_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_close_ready_count", contract->client_close_ready_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_rejected_no_open_count", contract->rejected_no_open_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_public_compile_count", contract->iokit_public_compile_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_public_link_count", contract->iokit_public_link_count);
    xnu_log_kv32("stage86_xnu_iokit_client_open_no_iokit_runtime_exec", contract->no_iokit_runtime_exec);
    xnu_log_kv32("stage86_xnu_iokit_client_open_no_open_runtime_exec", contract->no_open_runtime_exec);
    xnu_log_kv32("stage86_xnu_iokit_client_open_no_claim_runtime_exec", contract->no_claim_runtime_exec);
    xnu_log_kv32("stage86_xnu_iokit_client_open_no_close_runtime_exec", contract->no_close_runtime_exec);
    xnu_log_kv32("stage86_xnu_iokit_client_open_no_live_pmap_tables_installed", contract->no_live_pmap_tables_installed);
    xnu_log_kv32("stage86_xnu_iokit_client_open_proposed_workspace_written", contract->proposed_workspace_written);
    xnu_log_kv32("stage86_xnu_iokit_client_open_pmap_ttbr_written", contract->pmap_ttbr_written);
    xnu_log_kv32("stage86_xnu_iokit_client_open_pmap_tlbs_invalidated", contract->pmap_tlbs_invalidated);
    xnu_log_kv32("stage86_xnu_iokit_client_open_caches_changed", contract->caches_changed);
    xnu_log_kv32("stage86_xnu_iokit_client_open_persistent_write_attempted", contract->persistent_write_attempted);
}

int stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract_selftest(
    const struct stage86_loader_preflight *preflight)
{
    ...
    contract->version = STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_CONTRACT_VERSION;
    contract->size = sizeof(*contract);
    contract->status = STAGE86_STATUS_BASE;
    contract->required_mask = STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_REQUIRED_MASK;

    if (!preflight || !args || !root) {
        contract->failure_mask = STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SOURCE |
            STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SAFETY_BOUNDARY;
        contract->checksum = stage86_iokit_client_open_provider_claim_close_dryrun_checksum(contract);
        stage86_iokit_client_open_provider_claim_close_dryrun_log(contract);
        return 0;
    }
    ...
    if (u32_prop_equals(args, rejected_node, "client-open-dryrun", 0u) &&
        ...
        u32_prop_equals(args, rejected_node, "open-order", STAGE86_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "close-order", STAGE86_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "open-dependency-ready", 0u) &&
        string_prop_equals(args, rejected_node, "open-provenance", "stage86-rejected-noopen") &&
        u32_prop_equals(args, rejected_node, "rejected-candidate", 1u) &&
        u32_prop_equals(args, rejected_node, "stage-owned-local-only", 1u)) {
        contract->rejected_client_open_mask |= STAGE86_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    ...
    contract->client_open_path_hash = STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_PATH_HASH;
    contract->client_open_candidate_count = STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_CANDIDATE_COUNT;
    contract->selected_client_open_entry_count =
        (contract->selected_client_open_entry_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) ?
        STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_ENTRY_COUNT : 0u;
    contract->rejected_client_open_entry_count =
        (contract->rejected_client_open_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) ?
        STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_REJECTED_COUNT : 0u;
    ...
    contract->expected_client_open_checksum =
        STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_EXPECTED_CHECKSUM;
    ...
    source_ok = (contract->source_provider_callback_status == STAGE86_STATUS_OK &&
                 contract->source_provider_callback_satisfied_mask ==
                 STAGE86_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_REQUIRED_MASK &&
                 ...
                 contract->source_selected_provider_callback_entry_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_rejected_provider_callback_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
                 contract->source_provider_callback_matrix == (STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                                               STAGE86_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) &&
                 contract->source_client_ack_mask_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_no_callback_runtime_exec == 1u &&
                 contract->source_no_client_notification_runtime_exec == 1u &&
                 contract->source_provider_notification_status == STAGE86_STATUS_OK &&
    ...
    if (source_ok) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_SOURCE_PROVIDER_CALLBACK;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SOURCE;
    }

    if (contract->apple_dt_semantic_mask == STAGE86_DT_READY_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_APPLE_DT;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_DT;
    }
    ...
    if (personality_nodes_ok) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_PERSONALITY_NODE_SET;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_PERSONALITY;
    }

    if (contract->client_open_ready_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_CLIENT_OPEN_READY;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_OPEN;
    }
    if (contract->provider_claim_ready_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_PROVIDER_CLAIM_READY;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_CLAIM;
    }
    if (contract->client_close_ready_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_CLIENT_CLOSE_READY;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_CLOSE;
    }
    if (contract->open_provider_path_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_PROVIDER_PATH_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_OPEN;
    }
    if (contract->open_provider_ordinal_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_PROVIDER_ORDINAL_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_OPEN;
    }
    if (contract->open_type_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_OPEN_TYPE_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_OPEN;
    }
    if (contract->expected_open_mask_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_EXPECTED_OPEN_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_OPEN;
    }
    if (contract->claimed_open_mask_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_CLAIMED_OPEN_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_CLAIM;
    }
    if (contract->client_close_mask_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_CLIENT_CLOSE_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_CLOSE;
    }

    order_ok = (contract->open_order_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                contract->close_order_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) ? 1u : 0u;
    if (order_ok) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_ORDER_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_ORDER_DEPENDENCY;
    }
    open_dependency_ok = (contract->open_dependency_ready_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED);
    if (open_dependency_ok) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_DEPENDENCY_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_ORDER_DEPENDENCY;
    }
    if (contract->open_runtime_blocked_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->provider_claim_runtime_blocked_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->client_close_runtime_blocked_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_RUNTIME_BLOCKED;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->open_provenance_match_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_PROVENANCE;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_OPEN;
    }
    if (contract->selected_client_open_entry_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_SELECTED_OPEN_MATRIX;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_OPEN;
    }
    if (contract->rejected_client_open_mask == STAGE86_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_REJECT_NO_OPEN;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_REJECTED;
    }
    if (contract->client_open_candidate_count == STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_CANDIDATE_COUNT &&
        contract->selected_client_open_entry_count == STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_ENTRY_COUNT &&
        contract->rejected_client_open_entry_count == STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_REJECTED_COUNT &&
        contract->client_open_ready_count == STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_ENTRY_COUNT &&
        contract->provider_claim_ready_count == STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_ENTRY_COUNT &&
        contract->client_close_ready_count == STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_ENTRY_COUNT &&
        contract->rejected_no_open_count == STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_REJECTED_COUNT) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_DRYRUN_COUNTS;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_COUNTS;
    }
    if (contract->client_open_checksum == contract->expected_client_open_checksum) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_OPEN_CHECKSUM;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_CHECKSUM;
    }
    ...
    if (contract->iokit_reference_mask == STAGE86_XNU_IOKIT_REFERENCE_REQUIRED &&
        ...
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_IOKIT_REFERENCE;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    ...
    if (public_boundary_ok) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_PUBLIC_BOUNDARY;
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_NO_PUBLIC_XNU_EXEC;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    pmap_boundary_ok = (contract->no_public_pmap_exec == 1u && contract->no_live_pmap_tables_installed == 0u &&
                        ...
                        contract->caches_changed == 0u && contract->source_pmap_transition_status == STAGE86_STATUS_OK);
    if (pmap_boundary_ok) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_PMAP_BOUNDARY;
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_NO_PUBLIC_PMAP_EXEC;
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_NO_LIVE_PMAP_INSTALL;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_PMAP_BOUNDARY;
    }
    if (contract->no_iokit_runtime_exec == 1u && contract->no_callback_runtime_exec == 1u &&
        contract->no_client_notification_runtime_exec == 1u) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_NO_IOKIT_RUNTIME_EXEC;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->no_open_runtime_exec == 1u) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_NO_OPEN_RUNTIME_EXEC;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->no_claim_runtime_exec == 1u) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_NO_CLAIM_RUNTIME_EXEC;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->no_close_runtime_exec == 1u) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_NO_CLOSE_RUNTIME_EXEC;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->persistent_write_attempted == 0u && contract->local_only == 1u && contract->fail_closed == 1u) {
        contract->satisfied_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_SAT_LOCAL_ONLY_FAIL_CLOSED;
    } else {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    contract->checksum = stage86_iokit_client_open_provider_claim_close_dryrun_checksum(contract);
    if (contract->checksum != stage86_iokit_client_open_provider_claim_close_dryrun_checksum(contract)) {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_CHECKSUM;
    }

    contract->status = (contract->satisfied_mask == contract->required_mask && contract->failure_mask == 0u) ?
        STAGE86_STATUS_OK : (STAGE86_STATUS_FAIL(contract->failure_mask));
    if (contract->status != STAGE86_STATUS_OK) {
        contract->failure_mask |= STAGE86_XNU_IOKIT_CLIENT_OPEN_PROVIDER_CLAIM_CLOSE_DRYRUN_FAIL_ROLLUP;
...
const struct stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract *
stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract_result(void)
{
    return &g_stage86_xnu_iokit_client_open_provider_claim_close_readiness_dryrun_contract;
}
