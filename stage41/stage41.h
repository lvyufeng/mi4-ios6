#ifndef MI4IOS6_STAGE41_H
#define MI4IOS6_STAGE41_H

#include <stdint.h>
#include <stddef.h>

#define STAGE41_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage41;
...
extern struct gic_state_snapshot GIC_state_stage41;
extern volatile uint32_t stage41_irq_count;
extern volatile uint32_t stage41_last_iar;
extern volatile uint32_t stage41_last_irq_id;
extern volatile uint32_t stage41_timer_irq_count;
extern volatile uint32_t stage41_last_timer_irq_id;
...
/* stage41_main.c */
void stage41_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage41_image_end[];
extern uint8_t stage41_vectors[];
void trigger_stage41_undef_test(void) __attribute__((noreturn));
void trigger_stage41_data_abort_test(void) __attribute__((noreturn));
