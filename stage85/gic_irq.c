...
static struct stage85_gic_irq_state {
...
void stage85_gic_irq_init(void)
{
	...
	*gicc_pmr = 0xff;
	...
	g_gic_irq_state.init_status = STAGE85_STATUS_OK;
}

void stage85_gic_irq_enable_interrupt(uint32_t irq_id)
{
...
const struct stage85_gic_irq_state *stage85_gic_irq_state(void)
{
