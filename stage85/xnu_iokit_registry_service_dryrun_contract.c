...
static struct stage85_xnu_iokit_registry_service_dryrun_contract g_stage85_xnu_iokit_registry_service_dryrun_contract;

static uint32_t stage85_iokit_registry_service_dryrun_checksum(
    volatile const struct stage85_xnu_iokit_registry_service_dryrun_contract *contract)
{
    volatile const uint32_t *words = (volatile const uint32_t *)(uintptr_t)contract;
    uint32_t count = (uint32_t)(offsetof(struct stage85_xnu_iokit_registry_service_dryrun_contract, checksum) /
                                sizeof(uint32_t));
...
static void stage85_iokit_registry_service_dryrun_log(
    const struct stage85_xnu_iokit_registry_service_dryrun_contract *contract)
{
    xnu_log_kv32("stage85_xnu_iokit_registry_service_dryrun_contract_status", contract->status);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_dryrun_contract_required_mask", contract->required_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_dryrun_contract_satisfied_mask", contract->satisfied_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_dryrun_contract_failure_mask", contract->failure_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_dryrun_contract_checksum", contract->checksum);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_source_match_status", contract->source_match_status);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_apple_dt_semantic_mask", contract->apple_dt_semantic_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_registry_root_props", contract->registry_root_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_platform_props", contract->platform_driver_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_interrupt_props", contract->interrupt_service_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_timer_props", contract->timer_service_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_cpu_props", contract->cpu_service_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_rejected_props", contract->rejected_driver_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_provider_class_match_mask", contract->provider_class_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_category_match_mask", contract->category_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_compatible_match_mask", contract->compatible_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_probe_score_match_mask", contract->probe_score_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_local_only_mask", contract->local_only_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_selected_mask", contract->selected_service_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_rejected_mask", contract->rejected_service_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_fact_mask", contract->service_fact_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_platform_probe_score", contract->platform_probe_score);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_interrupt_probe_score", contract->interrupt_probe_score);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_timer_probe_score", contract->timer_probe_score);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_cpu_probe_score", contract->cpu_probe_score);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_rejected_probe_score", contract->rejected_probe_score);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_interrupt_gic_base", contract->interrupt_gic_base);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_interrupt_gic_cpu_base", contract->interrupt_gic_cpu_base);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_interrupt_irq_count", contract->interrupt_irq_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_timer_base", contract->timer_base);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_timer_frequency", contract->timer_frequency);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_timer_ppi_mask", contract->timer_ppi_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_cpu_count", contract->cpu_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_cpu_timebase_frequency", contract->cpu_timebase_frequency);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_provider_candidate_count", contract->provider_candidate_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_driver_candidate_count", contract->driver_candidate_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_selected_driver_count", contract->selected_driver_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_rejected_driver_count", contract->rejected_driver_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_dryrun_match_count", contract->dryrun_match_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_attach_deferred_count", contract->attach_deferred_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_start_deferred_count", contract->start_deferred_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_iokit_reference_mask", contract->iokit_reference_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_iokit_runtime_blocked_mask", contract->iokit_runtime_blocked_mask);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_public_compile_count", contract->iokit_public_compile_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_public_link_count", contract->iokit_public_link_count);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_no_iokit_runtime_exec", contract->no_iokit_runtime_exec);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_no_platform_driver_exec", contract->no_platform_driver_exec);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_no_live_pmap_tables_installed", contract->no_live_pmap_tables_installed);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_proposed_workspace_written", contract->proposed_workspace_written);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_pmap_ttbr_written", contract->pmap_ttbr_written);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_pmap_tlbs_invalidated", contract->pmap_tlbs_invalidated);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_caches_changed", contract->caches_changed);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_persistent_write_attempted", contract->persistent_write_attempted);
    xnu_log_kv32("stage85_xnu_iokit_registry_service_platform_gap_mask", contract->proposed_platform_gap_mask);
}

int stage85_xnu_iokit_registry_service_dryrun_contract_selftest(
    const struct stage85_loader_preflight *preflight)
{
    struct stage85_xnu_iokit_registry_service_dryrun_contract *contract =
        &g_stage85_xnu_iokit_registry_service_dryrun_contract;
    ...
    contract->version = STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_CONTRACT_VERSION;
    contract->size = sizeof(*contract);
    contract->status = STAGE85_STATUS_BASE;
    contract->required_mask = STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_REQUIRED_MASK;

    if (!preflight || !args || !root) {
        contract->failure_mask = STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_SOURCE |
            STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_SAFETY_BOUNDARY;
        contract->checksum = stage85_iokit_registry_service_dryrun_checksum(contract);
        stage85_iokit_registry_service_dryrun_log(contract);
        return 0;
    }
    ...
    if (!string_prop_equals(args, rejected_node, "IOProviderClass", "IOPlatformExpertDevice") &&
        ...
        contract->rejected_service_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    ...
    if (contract->platform_probe_score == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_PROBE_SCORE) {
        contract->probe_score_match_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (contract->interrupt_probe_score == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_PROBE_SCORE) {
        contract->probe_score_match_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (contract->timer_probe_score == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_TIMER_PROBE_SCORE) {
        contract->probe_score_match_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (contract->cpu_probe_score == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_CPU_PROBE_SCORE) {
    ...
    if (apple_dt_get_u32_prop(args->deviceTreeP, args->deviceTreeLength,
        ...
        contract->local_only_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (apple_dt_get_u32_prop(args->deviceTreeP, args->deviceTreeLength,
                              interrupt_node, "stage-owned-local-only", 0u) == 1u) {
        contract->local_only_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (apple_dt_get_u32_prop(args->deviceTreeP, args->deviceTreeLength,
                              timer_node, "stage-owned-local-only", 0u) == 1u) {
        contract->local_only_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (apple_dt_get_u32_prop(args->deviceTreeP, args->deviceTreeLength,
                              cpu_node, "stage-owned-local-only", 0u) == 1u) {
        contract->local_only_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT;
    }
    if (apple_dt_get_u32_prop(args->deviceTreeP, args->deviceTreeLength,
                              rejected_node, "stage-owned-local-only", 0u) == 1u) {
        contract->local_only_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    ...
    if (preflight->xnu_iokit_match_dryrun_contract.driver_gic_base ==
        STAGE85_XNU_IOKIT_PLATFORM_EXPECTED_GIC_DIST_BASE &&
        preflight->xnu_iokit_match_dryrun_contract.driver_timer_base ==
        STAGE85_XNU_IOKIT_PLATFORM_EXPECTED_TIMER_BASE) {
        contract->service_fact_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (contract->interrupt_gic_base == STAGE85_XNU_IOKIT_PLATFORM_EXPECTED_GIC_DIST_BASE &&
        contract->interrupt_gic_cpu_base == STAGE85_XNU_PEXPERT_HOOK_READINESS_EXPECTED_GIC_CPU_BASE &&
        contract->interrupt_irq_count >= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_EXPECTED_IRQ_COUNT_MIN) {
        contract->service_fact_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (contract->timer_base == STAGE85_XNU_IOKIT_PLATFORM_EXPECTED_TIMER_BASE &&
        contract->timer_frequency == STAGE85_XNU_IOKIT_PLATFORM_EXPECTED_TIMEBASE_FREQ &&
        contract->timer_ppi_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_TIMER_PPI_MASK) {
        contract->service_fact_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (contract->cpu_count == STAGE85_XNU_IOKIT_PLATFORM_EXPECTED_CPU_COUNT &&
        contract->cpu_timebase_frequency == STAGE85_XNU_IOKIT_PLATFORM_EXPECTED_TIMEBASE_FREQ) {
        contract->service_fact_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT;
    }
    ...
    contract->provider_candidate_count = STAGE85_XNU_IOKIT_REGISTRY_SERVICE_PROVIDER_COUNT;
    contract->driver_candidate_count = STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRIVER_CANDIDATE_COUNT;
    contract->selected_driver_count = (contract->selected_service_mask ==
                                       STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) ?
        STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_COUNT : 0u;
    contract->rejected_driver_count = (contract->rejected_service_mask ==
        ...
        STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_COUNT : 0u;
    ...
    source_ok = (contract->source_match_status == STAGE85_STATUS_OK &&
                 contract->source_match_satisfied_mask == STAGE85_XNU_IOKIT_MATCH_DRYRUN_REQUIRED_MASK &&
                 contract->source_match_failure_mask == 0u &&
                 contract->source_scaffold_status == STAGE85_STATUS_OK &&
                 contract->source_scaffold_satisfied_mask == STAGE85_XNU_IOKIT_PLATFORM_SCAFFOLD_REQUIRED_MASK &&
    ...
    if (source_ok) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_SOURCE_MATCH;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_SOURCE;
    }

    if (contract->apple_dt_semantic_mask == STAGE85_DT_READY_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_APPLE_DT;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_DT;
    }
    ...
    if (contract->registry_root_node_ptr != 0u && contract->registry_root_prop_count >= 6u &&
        ...
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_REGISTRY_ROOT;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_REGISTRY;
    }
    ...
    if (service_nodes_ok) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_SERVICE_NODE_SET;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_REGISTRY;
    }

    if (contract->provider_class_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_PROVIDER_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_MATCH;
    }
    if (contract->category_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_CATEGORY_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_MATCH;
    }
    if (contract->compatible_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_COMPATIBLE_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_MATCH;
    }
    if (contract->probe_score_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_PROBE_SCORE_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_MATCH;
    }
    if (contract->service_fact_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_SERVICE_FACTS;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_FACTS;
    }
    if (contract->rejected_service_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->rejected_driver_count == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_COUNT) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_REJECT_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_MATCH;
    }
    if (contract->provider_candidate_count == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_PROVIDER_COUNT &&
        contract->driver_candidate_count == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRIVER_CANDIDATE_COUNT &&
        contract->selected_driver_count == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_COUNT &&
        contract->rejected_driver_count == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_COUNT &&
        contract->dryrun_match_count == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_COUNT &&
        contract->service_match_matrix == (STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                           STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_DRYRUN_COUNTS;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_MATCH;
    }

    if (contract->attach_deferred == 1u && contract->start_deferred == 1u &&
        contract->attach_deferred_count == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_COUNT &&
        contract->start_deferred_count == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_COUNT) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_ATTACH_START_DEFERRED;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    ...
    if (contract->iokit_reference_mask == STAGE85_XNU_IOKIT_REFERENCE_REQUIRED &&
        ...
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_IOKIT_REFERENCE;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    ...
    if (public_boundary_ok) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_PUBLIC_BOUNDARY |
            STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_IOKIT_RUNTIME_EXEC |
            STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_PLATFORM_DRIVER_EXEC |
            STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_PUBLIC_XNU_EXEC;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }

    if (contract->no_public_pmap_exec == 1u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_PUBLIC_PMAP_EXEC;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_PMAP_BOUNDARY;
    }
    ...
    if (contract->no_live_pmap_tables_installed == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_LIVE_PMAP_INSTALL;
    }
    if (contract->proposed_workspace_written == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_PROPOSED_PMAP_WRITE;
    }
    if (contract->pmap_ttbr_written == 0u && contract->pmap_ttbcr_written == 0u &&
        contract->pmap_dacr_written == 0u && contract->pmap_sctlr_written == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_PMAP_CONTROL_WRITE;
    }
    if (contract->pmap_tlbs_invalidated == 0u && contract->caches_changed == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_TLB_CACHE_CHANGE;
    }
    if (pmap_boundary_ok && contract->source_pmap_transition_status == STAGE85_STATUS_OK &&
        contract->source_pmap_transition_failure_mask == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_PMAP_BOUNDARY;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_PMAP_BOUNDARY;
    }

    if (contract->xnu_start_executed == 0u && contract->generated_macho_executed == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_XNU_MACHO_EXEC;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->persistent_write_attempted == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_NO_PERSIST_WRITE;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    if (contract->proposed_platform_gap_mask == (STAGE85_PLATFORM_GAP_REQUIRED_RECORDED &
                                                 ~STAGE85_PLATFORM_GAP_IOKIT_STACK) &&
        contract->proposed_pexpert_gap_mask == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_PLATFORM_ROLLUP;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_ROLLUP;
    }

    if (contract->local_only == 1u && contract->fail_closed == 1u &&
        (contract->local_only_mask & (STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                      STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) ==
        (STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
         STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_SAT_FAIL_CLOSED;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    contract->checksum = stage85_iokit_registry_service_dryrun_checksum(contract);
    if (contract->checksum != stage85_iokit_registry_service_dryrun_checksum(contract)) {
        contract->failure_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_DRYRUN_FAIL_CHECKSUM;
    }
...
const struct stage85_xnu_iokit_registry_service_dryrun_contract *
stage85_xnu_iokit_registry_service_dryrun_contract_result(void)
{
    return &g_stage85_xnu_iokit_registry_service_dryrun_contract;
}
