...
static struct stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract
    g_stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract;

static uint32_t stage82_iokit_provider_notification_delivery_dryrun_checksum(
    volatile const struct stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract *contract)
{
    volatile const uint32_t *words = (volatile const uint32_t *)(uintptr_t)contract;
    uint32_t count = (uint32_t)(offsetof(struct stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract,
...
static void stage82_iokit_provider_notification_delivery_dryrun_log(
    const struct stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract *contract)
{
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract_status", contract->status);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract_required_mask", contract->required_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract_satisfied_mask", contract->satisfied_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract_failure_mask", contract->failure_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract_checksum", contract->checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_source_lifecycle_status", contract->source_lifecycle_status);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_source_lifecycle_satisfied_mask", contract->source_lifecycle_satisfied_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_source_lifecycle_failure_mask", contract->source_lifecycle_failure_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_source_lifecycle_checksum", contract->source_lifecycle_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_source_selected_lifecycle_entry_mask", contract->source_selected_lifecycle_entry_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_source_rejected_lifecycle_mask", contract->source_rejected_lifecycle_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_source_lifecycle_matrix", contract->source_lifecycle_matrix);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_apple_dt_semantic_mask", contract->apple_dt_semantic_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_platform_props", contract->platform_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interrupt_props", contract->interrupt_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_timer_props", contract->timer_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_cpu_props", contract->cpu_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_rejected_props", contract->rejected_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_ready_mask", contract->provider_notification_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interest_ready_mask", contract->interest_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_ready_mask", contract->delivery_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interest_provider_path_match_mask", contract->interest_provider_path_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interest_provider_ordinal_match_mask", contract->interest_provider_ordinal_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interest_type_match_mask", contract->interest_type_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_expected_notify_mask_match_mask", contract->expected_notify_mask_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivered_notify_mask_match_mask", contract->delivered_notify_mask_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_notify_dependency_ready_mask", contract->notify_dependency_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interest_runtime_blocked_mask", contract->interest_runtime_blocked_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_runtime_blocked_mask", contract->delivery_runtime_blocked_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interest_order_match_mask", contract->interest_order_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_order_match_mask", contract->delivery_order_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_notify_provenance_match_mask", contract->notify_provenance_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_selected_provider_notification_entry_mask", contract->selected_provider_notification_entry_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_rejected_provider_notification_mask", contract->rejected_provider_notification_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_matrix", contract->provider_notification_matrix);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interest_order_checksum", contract->interest_order_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_order_checksum", contract->delivery_order_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_notify_mask_checksum", contract->notify_mask_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_path_hash", contract->provider_notification_path_hash);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_checksum", contract->provider_notification_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_expected_checksum", contract->expected_provider_notification_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_candidate_count", contract->provider_notification_candidate_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_selected_entry_count", contract->selected_provider_notification_entry_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_rejected_entry_count", contract->rejected_provider_notification_entry_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_ready_count", contract->provider_notification_ready_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_interest_ready_count", contract->interest_ready_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_delivery_ready_count", contract->delivery_ready_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_dependency_ready_count", contract->notify_dependency_ready_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_rejected_undelivered_count", contract->rejected_undelivered_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_public_compile_count", contract->iokit_public_compile_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_public_link_count", contract->iokit_public_link_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_no_iokit_runtime_exec", contract->no_iokit_runtime_exec);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_no_interest_runtime_exec", contract->no_interest_runtime_exec);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_no_delivery_runtime_exec", contract->no_delivery_runtime_exec);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_no_live_pmap_tables_installed", contract->no_live_pmap_tables_installed);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_proposed_workspace_written", contract->proposed_workspace_written);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_pmap_ttbr_written", contract->pmap_ttbr_written);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_pmap_tlbs_invalidated", contract->pmap_tlbs_invalidated);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_caches_changed", contract->caches_changed);
    xnu_log_kv32("stage82_xnu_iokit_provider_notification_persistent_write_attempted", contract->persistent_write_attempted);
}
...
static void selected_masks_for_node(const struct boot_args *args, const void *node, uint32_t bit,
                                    ...
                                    uint32_t order,
                                    struct stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract *contract)
{
    ...
    if (string_prop_equals(args, node, "notify-provenance", "stage82-lifecycle-regsvc")) {
        contract->notify_provenance_match_mask |= bit;
    }
}

int stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract_selftest(
    const struct stage82_loader_preflight *preflight)
{
    ...
    contract->version = STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_CONTRACT_VERSION;
    contract->size = sizeof(*contract);
    contract->status = STAGE82_STATUS_BASE;
    contract->required_mask = STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_REQUIRED_MASK;

    if (!preflight || !args || !root) {
        contract->failure_mask = STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_SOURCE |
            STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_SAFETY_BOUNDARY;
        contract->checksum = stage82_iokit_provider_notification_delivery_dryrun_checksum(contract);
        stage82_iokit_provider_notification_delivery_dryrun_log(contract);
        return 0;
    }
    ...
    if (u32_prop_equals(args, rejected_node, "lifecycle-regsvc-dryrun", 0u) &&
        ...
        u32_prop_equals(args, rejected_node, "interest-order", STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "delivery-order", STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "notify-dependency-ready", 0u) &&
        string_prop_equals(args, rejected_node, "notify-provenance", "stage82-rejected-undelivered") &&
        u32_prop_equals(args, rejected_node, "rejected-candidate", 1u) &&
        u32_prop_equals(args, rejected_node, "stage-owned-local-only", 1u)) {
        contract->rejected_provider_notification_mask |= STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    ...
    contract->provider_notification_path_hash = STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_PATH_HASH;
    contract->provider_notification_candidate_count = STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_CANDIDATE_COUNT;
    contract->selected_provider_notification_entry_count =
        (contract->selected_provider_notification_entry_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) ?
        STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_ENTRY_COUNT : 0u;
    contract->rejected_provider_notification_entry_count =
        (contract->rejected_provider_notification_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) ?
        STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_REJECTED_COUNT : 0u;
    ...
    contract->expected_provider_notification_checksum =
        STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_EXPECTED_CHECKSUM;
    ...
    source_ok = (contract->source_lifecycle_status == STAGE82_STATUS_OK &&
                 contract->source_lifecycle_satisfied_mask ==
                 STAGE82_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_REQUIRED_MASK &&
                 contract->source_lifecycle_failure_mask == 0u &&
                 contract->source_lifecycle_checksum == STAGE82_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_EXPECTED_CHECKSUM &&
                 contract->source_selected_lifecycle_entry_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_rejected_lifecycle_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
                 contract->source_lifecycle_matrix == (STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                                       STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) &&
                 contract->source_notification_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_register_service_readiness_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_service_registered_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
    ...
    if (source_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_SOURCE_LIFECYCLE;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_SOURCE;
    }

    if (contract->apple_dt_semantic_mask == STAGE82_DT_READY_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_APPLE_DT;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_DT;
    }
    ...
    if (personality_nodes_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_PERSONALITY_NODE_SET;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PERSONALITY;
    }

    if (contract->provider_notification_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_PROVIDER_NOTIFICATION_READY;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PROVIDER_NOTIFICATION;
    }
    if (contract->interest_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_INTEREST_READY;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_INTEREST;
    }
    if (contract->delivery_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_DELIVERY_READY;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_DELIVERY;
    }
    if (contract->interest_provider_path_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_PROVIDER_PATH_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_INTEREST;
    }
    if (contract->interest_provider_ordinal_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_PROVIDER_ORDINAL_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_INTEREST;
    }
    if (contract->interest_type_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_INTEREST_TYPE_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_INTEREST;
    }
    if (contract->expected_notify_mask_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_EXPECTED_NOTIFY_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PROVIDER_NOTIFICATION;
    }
    if (contract->delivered_notify_mask_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_DELIVERED_NOTIFY_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_DELIVERY;
    }

    order_ok = (contract->interest_order_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                contract->delivery_order_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                contract->interest_order_checksum == STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL &&
                contract->delivery_order_checksum == STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) ? 1u : 0u;
    if (order_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_ORDER_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_ORDER_DEPENDENCY;
    }

    notification_dependency_ok =
        (contract->notify_dependency_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
         contract->notify_dependency_ready_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_ENTRY_COUNT) ? 1u : 0u;
    if (notification_dependency_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_DEPENDENCY_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_ORDER_DEPENDENCY;
    }

    if (contract->interest_runtime_blocked_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->delivery_runtime_blocked_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->no_interest_runtime_exec == 1u && contract->no_delivery_runtime_exec == 1u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_RUNTIME_BLOCKED;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_INTEREST |
            STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_DELIVERY;
    }
    if (contract->notify_provenance_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_PROVENANCE;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PROVIDER_NOTIFICATION;
    }
    if (contract->selected_provider_notification_entry_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_SELECTED_NOTIFICATION_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PROVIDER_NOTIFICATION;
    }
    if (contract->rejected_provider_notification_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->source_rejected_lifecycle_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->rejected_undelivered_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_REJECTED_COUNT) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_REJECT_UNDELIVERED;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_REJECTED;
    }
    if (contract->provider_notification_candidate_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_CANDIDATE_COUNT &&
        contract->selected_provider_notification_entry_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_ENTRY_COUNT &&
        contract->rejected_provider_notification_entry_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_REJECTED_COUNT &&
        contract->provider_notification_ready_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_ENTRY_COUNT &&
        contract->interest_ready_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_ENTRY_COUNT &&
        contract->delivery_ready_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_ENTRY_COUNT &&
        contract->notify_dependency_ready_count == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_ENTRY_COUNT &&
        contract->provider_notification_matrix == (STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                                  STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_DRYRUN_COUNTS;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_COUNTS;
    }
    if (contract->provider_notification_checksum == contract->expected_provider_notification_checksum) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NOTIFICATION_CHECKSUM;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_CHECKSUM;
    }
    ...
    if (contract->iokit_reference_mask == STAGE82_XNU_IOKIT_REFERENCE_REQUIRED &&
        ...
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_IOKIT_REFERENCE;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    ...
    if (public_boundary_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_PUBLIC_BOUNDARY |
            STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NO_IOKIT_RUNTIME_EXEC |
            STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NO_INTEREST_RUNTIME_EXEC |
            STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NO_DELIVERY_RUNTIME_EXEC |
            STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NO_PUBLIC_XNU_EXEC;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }

    if (contract->no_public_pmap_exec == 1u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NO_PUBLIC_PMAP_EXEC;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PMAP_BOUNDARY;
    }
    ...
    if (contract->no_live_pmap_tables_installed == 0u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NO_LIVE_PMAP_INSTALL;
    }
    if (contract->pmap_tlbs_invalidated == 0u && contract->caches_changed == 0u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NO_TLB_CACHE_CHANGE;
    }
    if (pmap_boundary_ok && contract->source_pmap_transition_status == STAGE82_STATUS_OK) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_PMAP_BOUNDARY;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_PMAP_BOUNDARY;
    }

    if (contract->generated_macho_executed == 0u && contract->xnu_start_executed == 0u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_NO_XNU_MACHO_EXEC;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->local_only == 1u && contract->fail_closed == 1u &&
        ...
        contract->selected_provider_notification_entry_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->rejected_provider_notification_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_SAT_LOCAL_ONLY_FAIL_CLOSED;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_ROLLUP |
            STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    contract->checksum = stage82_iokit_provider_notification_delivery_dryrun_checksum(contract);
    if (contract->checksum != stage82_iokit_provider_notification_delivery_dryrun_checksum(contract)) {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_FAIL_CHECKSUM;
    }
...
const struct stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract *
stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract_result(void)
{
    return &g_stage82_xnu_iokit_provider_notification_delivery_readiness_dryrun_contract;
}
