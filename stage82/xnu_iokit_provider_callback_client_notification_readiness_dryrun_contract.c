...
static struct stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract
    g_stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract;

static uint32_t stage82_iokit_provider_callback_client_notification_dryrun_checksum(
    volatile const struct stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract *contract)
{
    volatile const uint32_t *words = (volatile const uint32_t *)(uintptr_t)contract;
    uint32_t count = (uint32_t)(offsetof(struct stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract,
...
static void selected_masks_for_node(const struct boot_args *args, const void *node, uint32_t bit,
                                    ...
                                    uint32_t order,
                                    struct stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract *contract)
{
    ...
    if (string_prop_equals(args, node, "callback-provenance", "stage82-provider-notify")) {
        contract->callback_provenance_match_mask |= bit;
    }
}

static void stage82_iokit_provider_callback_client_notification_dryrun_log(
    const struct stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract *contract)
{
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract_status", contract->status);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract_required_mask", contract->required_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract_satisfied_mask", contract->satisfied_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract_failure_mask", contract->failure_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract_checksum", contract->checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_status", contract->source_provider_notification_status);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_satisfied_mask", contract->source_provider_notification_satisfied_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_failure_mask", contract->source_provider_notification_failure_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_checksum", contract->source_provider_notification_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_selected_provider_notification_entry_mask", contract->source_selected_provider_notification_entry_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_rejected_provider_notification_mask", contract->source_rejected_provider_notification_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_provider_notification_matrix", contract->source_provider_notification_matrix);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_interest_ready_mask", contract->source_interest_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_source_delivery_ready_mask", contract->source_delivery_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_apple_dt_semantic_mask", contract->apple_dt_semantic_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_platform_props", contract->platform_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_interrupt_props", contract->interrupt_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_timer_props", contract->timer_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_cpu_props", contract->cpu_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_rejected_props", contract->rejected_personality_prop_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_ready_mask", contract->provider_callback_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_ready_mask", contract->client_notification_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_provider_path_match_mask", contract->callback_provider_path_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_provider_ordinal_match_mask", contract->callback_provider_ordinal_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_type_match_mask", contract->callback_type_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_expected_callback_mask_match_mask", contract->expected_callback_mask_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_delivered_callback_mask_match_mask", contract->delivered_callback_mask_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_ack_mask_match_mask", contract->client_ack_mask_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_dependency_ready_mask", contract->callback_dependency_ready_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_runtime_blocked_mask", contract->callback_runtime_blocked_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_runtime_blocked_mask", contract->client_notification_runtime_blocked_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_order_match_mask", contract->callback_order_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_order_match_mask", contract->client_notification_order_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_provenance_match_mask", contract->callback_provenance_match_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_selected_provider_callback_entry_mask", contract->selected_provider_callback_entry_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_rejected_provider_callback_mask", contract->rejected_provider_callback_mask);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_matrix", contract->provider_callback_client_notification_matrix);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_callback_order_checksum", contract->callback_order_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_order_checksum", contract->client_notification_order_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_mask_checksum", contract->callback_mask_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_path_hash", contract->provider_callback_path_hash);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_checksum", contract->provider_callback_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_expected_checksum", contract->expected_provider_callback_checksum);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_candidate_count", contract->provider_callback_candidate_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_selected_entry_count", contract->selected_provider_callback_entry_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_rejected_entry_count", contract->rejected_provider_callback_entry_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_ready_count", contract->provider_callback_ready_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_notification_ready_count", contract->client_notification_ready_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_dependency_ready_count", contract->callback_dependency_ready_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_client_ack_ready_count", contract->client_ack_ready_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_rejected_no_callback_count", contract->rejected_no_callback_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_public_compile_count", contract->iokit_public_compile_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_public_link_count", contract->iokit_public_link_count);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_no_iokit_runtime_exec", contract->no_iokit_runtime_exec);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_no_callback_runtime_exec", contract->no_callback_runtime_exec);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_no_client_notification_runtime_exec", contract->no_client_notification_runtime_exec);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_no_live_pmap_tables_installed", contract->no_live_pmap_tables_installed);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_proposed_workspace_written", contract->proposed_workspace_written);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_pmap_ttbr_written", contract->pmap_ttbr_written);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_pmap_tlbs_invalidated", contract->pmap_tlbs_invalidated);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_caches_changed", contract->caches_changed);
    xnu_log_kv32("stage82_xnu_iokit_provider_callback_persistent_write_attempted", contract->persistent_write_attempted);
}

int stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract_selftest(
    const struct stage82_loader_preflight *preflight)
{
    ...
    contract->version = STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_CONTRACT_VERSION;
    contract->size = sizeof(*contract);
    contract->status = STAGE82_STATUS_BASE;
    contract->required_mask = STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_REQUIRED_MASK;

    if (!preflight || !args || !root) {
        contract->failure_mask = STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_SOURCE |
            STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_SAFETY_BOUNDARY;
        contract->checksum = stage82_iokit_provider_callback_client_notification_dryrun_checksum(contract);
        stage82_iokit_provider_callback_client_notification_dryrun_log(contract);
        return 0;
    }
    ...
    selected_masks_for_node(args, platform_node, STAGE82_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT,
                            "IODeviceTree:/", STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL,
                            STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL, contract);
    selected_masks_for_node(args, interrupt_node, STAGE82_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT,
                            "IODeviceTree:/stage82-platform-personality",
                            STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL,
                            STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_INTERRUPT_ORDINAL, contract);
    selected_masks_for_node(args, timer_node, STAGE82_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT,
                            "IODeviceTree:/stage82-platform-personality",
                            STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL,
                            STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_TIMER_ORDINAL, contract);
    selected_masks_for_node(args, cpu_node, STAGE82_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT,
                            "IODeviceTree:/stage82-platform-personality",
                            STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL,
                            STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_CPU_ORDINAL, contract);
    ...
    if (u32_prop_equals(args, rejected_node, "prov-notify-dryrun", 0u) &&
        ...
        u32_prop_equals(args, rejected_node, "callback-provider-ordinal",
                        STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        ...
        u32_prop_equals(args, rejected_node, "callback-order", STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "client-notify-order", STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "callback-dependency-ready", 0u) &&
        string_prop_equals(args, rejected_node, "callback-provenance", "stage82-rejected-nocallback") &&
        u32_prop_equals(args, rejected_node, "rejected-candidate", 1u) &&
        u32_prop_equals(args, rejected_node, "stage-owned-local-only", 1u)) {
        contract->rejected_provider_callback_mask |= STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    ...
    contract->provider_callback_path_hash = STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_PATH_HASH;
    contract->provider_callback_candidate_count = STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_CANDIDATE_COUNT;
    contract->selected_provider_callback_entry_count =
        (contract->selected_provider_callback_entry_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) ?
        STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_ENTRY_COUNT : 0u;
    contract->rejected_provider_callback_entry_count =
        (contract->rejected_provider_callback_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) ?
        STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_REJECTED_COUNT : 0u;
    ...
    contract->expected_provider_callback_checksum =
        STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_EXPECTED_CHECKSUM;
    ...
    source_ok = (contract->source_provider_notification_status == STAGE82_STATUS_OK &&
                 contract->source_provider_notification_satisfied_mask ==
                 STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_DRYRUN_REQUIRED_MASK &&
                 contract->source_provider_notification_failure_mask == 0u &&
                 contract->source_provider_notification_checksum == STAGE82_XNU_IOKIT_PROVIDER_NOTIFICATION_DELIVERY_EXPECTED_CHECKSUM &&
                 contract->source_selected_provider_notification_entry_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_rejected_provider_notification_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
                 contract->source_provider_notification_matrix == (STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                                                   STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) &&
                 contract->source_provider_notification_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_interest_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_delivery_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_no_interest_runtime_exec == 1u &&
                 contract->source_no_delivery_runtime_exec == 1u &&
                 contract->source_lifecycle_status == STAGE82_STATUS_OK &&
                 contract->source_attach_start_status == STAGE82_STATUS_OK &&
                 contract->source_topology_status == STAGE82_STATUS_OK &&
                 contract->source_property_inheritance_status == STAGE82_STATUS_OK &&
                 contract->source_catalog_status == STAGE82_STATUS_OK &&
    ...
    if (source_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_SOURCE_PROVIDER_NOTIFICATION;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_SOURCE;
    }

    if (contract->apple_dt_semantic_mask == STAGE82_DT_READY_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_APPLE_DT;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_DT;
    }
    ...
    if (personality_nodes_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_PERSONALITY_NODE_SET;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_PERSONALITY;
    }

    if (contract->provider_callback_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_PROVIDER_CALLBACK_READY;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK;
    }
    if (contract->client_notification_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_CLIENT_NOTIFICATION_READY;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CLIENT_NOTIFICATION;
    }
    if (contract->callback_provider_path_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_PROVIDER_PATH_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK;
    }
    if (contract->callback_provider_ordinal_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_PROVIDER_ORDINAL_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK;
    }
    if (contract->callback_type_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_CALLBACK_TYPE_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK;
    }
    if (contract->expected_callback_mask_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_EXPECTED_CALLBACK_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK;
    }
    if (contract->delivered_callback_mask_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_DELIVERED_CALLBACK_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK;
    }
    if (contract->client_ack_mask_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_CLIENT_ACK_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_ACK;
    }

    order_ok = (contract->callback_order_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                contract->client_notification_order_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                contract->callback_order_checksum == STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL &&
                contract->client_notification_order_checksum == STAGE82_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) ? 1u : 0u;
    if (order_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_ORDER_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_ORDER_DEPENDENCY;
    }

    callback_dependency_ok =
        (contract->callback_dependency_ready_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
         contract->callback_dependency_ready_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_ENTRY_COUNT) ? 1u : 0u;
    if (callback_dependency_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_DEPENDENCY_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_ORDER_DEPENDENCY;
    }

    if (contract->callback_runtime_blocked_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->client_notification_runtime_blocked_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->no_callback_runtime_exec == 1u && contract->no_client_notification_runtime_exec == 1u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_RUNTIME_BLOCKED;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK |
            STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CLIENT_NOTIFICATION;
    }
    if (contract->callback_provenance_match_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_PROVENANCE;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK;
    }
    if (contract->selected_provider_callback_entry_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_SELECTED_CALLBACK_MATRIX;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CALLBACK;
    }
    if (contract->rejected_provider_callback_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->source_rejected_provider_notification_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->rejected_no_callback_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_REJECTED_COUNT) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_REJECT_NO_CALLBACK;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_REJECTED;
    }
    if (contract->provider_callback_candidate_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_CANDIDATE_COUNT &&
        contract->selected_provider_callback_entry_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_ENTRY_COUNT &&
        contract->rejected_provider_callback_entry_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_REJECTED_COUNT &&
        contract->provider_callback_ready_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_ENTRY_COUNT &&
        contract->client_notification_ready_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_ENTRY_COUNT &&
        contract->callback_dependency_ready_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_ENTRY_COUNT &&
        contract->client_ack_ready_count == STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_ENTRY_COUNT &&
        contract->provider_callback_client_notification_matrix == (STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                                                  STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_DRYRUN_COUNTS;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_COUNTS;
    }
    if (contract->provider_callback_checksum == contract->expected_provider_callback_checksum) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_CALLBACK_CHECKSUM;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CHECKSUM;
    }
    ...
    if (contract->iokit_reference_mask == STAGE82_XNU_IOKIT_REFERENCE_REQUIRED &&
        ...
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_IOKIT_REFERENCE;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    ...
    if (public_boundary_ok) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_PUBLIC_BOUNDARY |
            STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_NO_IOKIT_RUNTIME_EXEC |
            STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_NO_CALLBACK_RUNTIME_EXEC |
            STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_NO_CLIENT_NOTIFICATION_RUNTIME_EXEC |
            STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_NO_PUBLIC_XNU_EXEC;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }

    if (contract->no_public_pmap_exec == 1u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_NO_PUBLIC_PMAP_EXEC;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_PMAP_BOUNDARY;
    }
    ...
    if (contract->no_live_pmap_tables_installed == 0u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_NO_LIVE_PMAP_INSTALL;
    }
    if (contract->pmap_tlbs_invalidated == 0u && contract->caches_changed == 0u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_NO_TLB_CACHE_CHANGE;
    }
    if (pmap_boundary_ok && contract->source_pmap_transition_status == STAGE82_STATUS_OK) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_PMAP_BOUNDARY;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_PMAP_BOUNDARY;
    }

    if (contract->generated_macho_executed == 0u && contract->xnu_start_executed == 0u) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_NO_XNU_MACHO_EXEC;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->local_only == 1u && contract->fail_closed == 1u &&
        ...
        contract->selected_provider_callback_entry_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->rejected_provider_callback_mask == STAGE82_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_SAT_LOCAL_ONLY_FAIL_CLOSED;
    } else {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_ROLLUP |
            STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    contract->checksum = stage82_iokit_provider_callback_client_notification_dryrun_checksum(contract);
    if (contract->checksum != stage82_iokit_provider_callback_client_notification_dryrun_checksum(contract)) {
        contract->failure_mask |= STAGE82_XNU_IOKIT_PROVIDER_CALLBACK_CLIENT_NOTIFICATION_DRYRUN_FAIL_CHECKSUM;
    }
...
const struct stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract *
stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract_result(void)
{
    return &g_stage82_xnu_iokit_provider_callback_client_notification_readiness_dryrun_contract;
}
