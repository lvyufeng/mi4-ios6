#ifndef MI4IOS6_STAGE16_H
#define MI4IOS6_STAGE16_H

#include <stdint.h>
#include <stddef.h>

#define STAGE16_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage16;
...
extern struct gic_state_snapshot GIC_state_stage16;
extern volatile uint32_t stage16_irq_count;
extern volatile uint32_t stage16_last_iar;
extern volatile uint32_t stage16_last_irq_id;
extern volatile uint32_t stage16_timer_irq_count;
extern volatile uint32_t stage16_last_timer_irq_id;
...
/* stage16_main.c */
void stage16_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage16_image_end[];
extern uint8_t stage16_vectors[];
void trigger_stage16_undef_test(void) __attribute__((noreturn));
void trigger_stage16_data_abort_test(void) __attribute__((noreturn));
