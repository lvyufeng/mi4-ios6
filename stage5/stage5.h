#ifndef MI4IOS6_STAGE5_H
#define MI4IOS6_STAGE5_H

#include <stdint.h>
#include <stddef.h>

#define STAGE5_BASE          0x00008000u
...
/* stage5_main.c */
void stage5_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage5_image_end[];
extern uint8_t stage5_vectors[];
void trigger_stage5_undef_test(void) __attribute__((noreturn));
