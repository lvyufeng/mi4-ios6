#ifndef MI4IOS6_STAGE30_H
#define MI4IOS6_STAGE30_H

#include <stdint.h>
#include <stddef.h>

#define STAGE30_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage30;
...
extern struct gic_state_snapshot GIC_state_stage30;
extern volatile uint32_t stage30_irq_count;
extern volatile uint32_t stage30_last_iar;
extern volatile uint32_t stage30_last_irq_id;
extern volatile uint32_t stage30_timer_irq_count;
extern volatile uint32_t stage30_last_timer_irq_id;
...
/* stage30_main.c */
void stage30_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage30_image_end[];
extern uint8_t stage30_vectors[];
void trigger_stage30_undef_test(void) __attribute__((noreturn));
void trigger_stage30_data_abort_test(void) __attribute__((noreturn));
