...
static struct stage88_xnu_iokit_catalog_property_dryrun_contract g_stage88_xnu_iokit_catalog_property_dryrun_contract;

static uint32_t stage88_iokit_catalog_property_dryrun_checksum(
    volatile const struct stage88_xnu_iokit_catalog_property_dryrun_contract *contract)
{
    volatile const uint32_t *words = (volatile const uint32_t *)(uintptr_t)contract;
    uint32_t count = (uint32_t)(offsetof(struct stage88_xnu_iokit_catalog_property_dryrun_contract, checksum) /
                                sizeof(uint32_t));
...
static void stage88_iokit_catalog_property_dryrun_log(
    const struct stage88_xnu_iokit_catalog_property_dryrun_contract *contract)
{
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_dryrun_contract_status", contract->status);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_dryrun_contract_required_mask", contract->required_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_dryrun_contract_satisfied_mask", contract->satisfied_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_dryrun_contract_failure_mask", contract->failure_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_dryrun_contract_checksum", contract->checksum);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_provider_status", contract->source_provider_status);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_provider_satisfied_mask", contract->source_provider_satisfied_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_registry_status", contract->source_registry_status);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_apple_dt_semantic_mask", contract->apple_dt_semantic_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_root_props", contract->catalog_root_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_catalog_version", contract->catalog_version);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_catalog_local_only", contract->catalog_local_only);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_platform_props", contract->platform_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_interrupt_props", contract->interrupt_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_timer_props", contract->timer_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_cpu_props", contract->cpu_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_rejected_props", contract->rejected_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_selected_mask", contract->source_selected_service_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_rejected_mask", contract->source_rejected_service_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_fact_mask", contract->source_service_fact_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_parent_mask", contract->source_parent_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_dependency_mask", contract->source_dependency_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_source_publish_order_mask", contract->source_publish_order_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_name_match_mask", contract->personality_name_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_bundle_match_mask", contract->bundle_identifier_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_catalog_marker_mask", contract->catalog_marker_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_provider_class_match_mask", contract->provider_class_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_category_match_mask", contract->category_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_compatible_match_mask", contract->compatible_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_probe_score_match_mask", contract->probe_score_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_local_only_match_mask", contract->local_only_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_selected_personality_mask", contract->selected_personality_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_rejected_personality_mask", contract->rejected_personality_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_matrix", contract->catalog_property_matrix);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_platform_ordinal", contract->platform_personality_ordinal);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_interrupt_ordinal", contract->interrupt_personality_ordinal);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_timer_ordinal", contract->timer_personality_ordinal);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_cpu_ordinal", contract->cpu_personality_ordinal);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_rejected_ordinal", contract->rejected_personality_ordinal);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_order_checksum", contract->personality_order_checksum);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_checksum", contract->personality_property_checksum);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_expected_checksum", contract->expected_property_checksum);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_catalog_count", contract->catalog_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_personality_candidate_count", contract->personality_candidate_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_selected_personality_count", contract->selected_personality_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_rejected_personality_count", contract->rejected_personality_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_dryrun_count", contract->property_dryrun_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_attach_deferred_count", contract->attach_deferred_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_start_deferred_count", contract->start_deferred_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_iokit_reference_mask", contract->iokit_reference_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_iokit_runtime_blocked_mask", contract->iokit_runtime_blocked_mask);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_public_compile_count", contract->iokit_public_compile_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_public_link_count", contract->iokit_public_link_count);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_no_iokit_runtime_exec", contract->no_iokit_runtime_exec);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_no_catalog_runtime_exec", contract->no_catalog_runtime_exec);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_no_provider_runtime_exec", contract->no_provider_runtime_exec);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_no_platform_driver_exec", contract->no_platform_driver_exec);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_no_live_pmap_tables_installed", contract->no_live_pmap_tables_installed);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_proposed_workspace_written", contract->proposed_workspace_written);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_pmap_ttbr_written", contract->pmap_ttbr_written);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_pmap_tlbs_invalidated", contract->pmap_tlbs_invalidated);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_caches_changed", contract->caches_changed);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_persistent_write_attempted", contract->persistent_write_attempted);
    xnu_log_kv32("stage88_xnu_iokit_catalog_property_platform_gap_mask", contract->proposed_platform_gap_mask);
}

int stage88_xnu_iokit_catalog_property_dryrun_contract_selftest(
    const struct stage88_loader_preflight *preflight)
{
    struct stage88_xnu_iokit_catalog_property_dryrun_contract *contract =
        &g_stage88_xnu_iokit_catalog_property_dryrun_contract;
    ...
    contract->version = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_CONTRACT_VERSION;
    contract->size = sizeof(*contract);
    contract->status = STAGE88_STATUS_BASE;
    contract->required_mask = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_REQUIRED_MASK;

    if (!preflight || !args || !root) {
        contract->failure_mask = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_SOURCE |
            STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_SAFETY_BOUNDARY;
        contract->checksum = stage88_iokit_catalog_property_dryrun_checksum(contract);
        stage88_iokit_catalog_property_dryrun_log(contract);
        return 0;
    }
    ...
    if (string_prop_equals(args, platform_node, "name", "stage88-platform-personality")) {
        contract->personality_name_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (string_prop_equals(args, interrupt_node, "name", "stage88-interrupt-personality")) {
        contract->personality_name_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (string_prop_equals(args, timer_node, "name", "stage88-timer-personality")) {
        contract->personality_name_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (string_prop_equals(args, cpu_node, "name", "stage88-cpu-personality")) {
        contract->personality_name_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT;
    }

    if (string_prop_equals(args, platform_node, "CFBundleIdentifier", "com.mi4ios6.stage88.localcatalog")) {
        contract->bundle_identifier_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (string_prop_equals(args, interrupt_node, "CFBundleIdentifier", "com.mi4ios6.stage88.localcatalog")) {
        contract->bundle_identifier_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (string_prop_equals(args, timer_node, "CFBundleIdentifier", "com.mi4ios6.stage88.localcatalog")) {
        contract->bundle_identifier_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (string_prop_equals(args, cpu_node, "CFBundleIdentifier", "com.mi4ios6.stage88.localcatalog")) {
        contract->bundle_identifier_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT;
    }
    ...
    if (u32_prop_equals(args, platform_node, "catalog-property-dryrun", 1u) &&
        ...
        contract->catalog_marker_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (u32_prop_equals(args, interrupt_node, "catalog-property-dryrun", 1u) &&
        ...
        contract->catalog_marker_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (u32_prop_equals(args, timer_node, "catalog-property-dryrun", 1u) &&
        u32_prop_equals(args, timer_node, "provider-plane-published", 1u)) {
        contract->catalog_marker_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (u32_prop_equals(args, cpu_node, "catalog-property-dryrun", 1u) &&
        u32_prop_equals(args, cpu_node, "provider-plane-published", 1u)) {
        contract->catalog_marker_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT;
    }
    ...
    if (u32_prop_equals(args, platform_node, "stage-owned-local-only", 1u)) {
        contract->local_only_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT;
    }
    if (u32_prop_equals(args, interrupt_node, "stage-owned-local-only", 1u)) {
        contract->local_only_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT;
    }
    if (u32_prop_equals(args, timer_node, "stage-owned-local-only", 1u)) {
        contract->local_only_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT;
    }
    if (u32_prop_equals(args, cpu_node, "stage-owned-local-only", 1u)) {
        contract->local_only_match_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT;
    }
    ...
    if (string_prop_equals(args, rejected_node, "name", "stage88-rejected-personality") &&
        string_prop_equals(args, rejected_node, "CFBundleIdentifier", "com.mi4ios6.stage88.localcatalog") &&
        ...
        contract->rejected_personality_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    contract->catalog_property_matrix = contract->selected_personality_mask | contract->rejected_personality_mask;

    contract->platform_personality_ordinal = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_PLATFORM_ORDINAL;
    contract->interrupt_personality_ordinal = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_INTERRUPT_ORDINAL;
    contract->timer_personality_ordinal = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_TIMER_ORDINAL;
    contract->cpu_personality_ordinal = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_CPU_ORDINAL;
    contract->rejected_personality_ordinal = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_REJECTED_ORDINAL;
    ...
    contract->catalog_count = (contract->catalog_root_node_ptr != 0u) ?
        STAGE88_XNU_IOKIT_CATALOG_PROPERTY_CATALOG_COUNT : 0u;
    contract->personality_candidate_count = STAGE88_XNU_IOKIT_CATALOG_PROPERTY_PERSONALITY_COUNT;
    contract->selected_personality_count = (contract->selected_personality_mask ==
        ...
        STAGE88_XNU_IOKIT_CATALOG_PROPERTY_SELECTED_COUNT : 0u;
    contract->rejected_personality_count = (contract->rejected_personality_mask ==
        ...
        STAGE88_XNU_IOKIT_CATALOG_PROPERTY_REJECTED_COUNT : 0u;
    ...
    source_ok = (contract->source_provider_status == STAGE88_STATUS_OK &&
    ...
    if (source_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_SOURCE_PROVIDER;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_SOURCE;
    }

    if (contract->apple_dt_semantic_mask == STAGE88_DT_READY_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_APPLE_DT;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_DT;
    }

    catalog_ok = (contract->catalog_root_node_ptr != 0u && contract->catalog_root_prop_count >= 6u &&
                  contract->catalog_name_present == 1u &&
                  contract->catalog_version == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_CATALOG_VERSION &&
                  contract->catalog_local_only == 1u && contract->catalog_count == 1u) ? 1u : 0u;
    if (catalog_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_CATALOG_ROOT;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_CATALOG;
    }
    ...
    if (personality_nodes_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_PERSONALITY_NODE_SET;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PERSONALITY;
    }

    if (contract->personality_name_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_PERSONALITY_NAME_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PERSONALITY;
    }
    if (contract->bundle_identifier_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_BUNDLE_IDENTIFIER_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PERSONALITY;
    }
    if (contract->catalog_marker_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_CATALOG_MARKER_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PERSONALITY;
    }
    if (contract->provider_class_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->source_parent_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_PROVIDER_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_MATCH;
    }
    if (contract->category_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_CATEGORY_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_MATCH;
    }
    if (contract->compatible_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_COMPATIBLE_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_MATCH;
    }
    if (contract->probe_score_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_PROBE_SCORE_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_MATCH;
    }
    if (contract->local_only_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_LOCAL_ONLY_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PERSONALITY;
    }
    if (contract->source_service_fact_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->source_dependency_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->source_publish_order_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_SERVICE_FACTS;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_FACTS;
    }
    if (contract->rejected_personality_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->source_rejected_service_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->rejected_personality_ordinal == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_REJECTED_ORDINAL) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_REJECT_PERSONALITY;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PERSONALITY;
    }
    if (contract->catalog_count == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_CATALOG_COUNT &&
        contract->personality_candidate_count == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_PERSONALITY_COUNT &&
        contract->selected_personality_count == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_SELECTED_COUNT &&
        contract->rejected_personality_count == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_REJECTED_COUNT &&
        contract->property_dryrun_count == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_SELECTED_COUNT &&
        contract->catalog_property_matrix == (STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                              STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_DRYRUN_COUNTS;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_COUNTS;
    }
    if (contract->personality_order_checksum == 0xffffffffu &&
        ...
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_PROPERTY_CHECKSUM;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_CHECKSUM;
    }
    if (contract->attach_deferred == 1u && contract->start_deferred == 1u &&
        contract->attach_deferred_count == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_SELECTED_COUNT &&
        contract->start_deferred_count == STAGE88_XNU_IOKIT_CATALOG_PROPERTY_SELECTED_COUNT) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_ATTACH_START_DEFERRED;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    ...
    if (contract->iokit_reference_mask == STAGE88_XNU_IOKIT_REFERENCE_REQUIRED &&
        ...
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_IOKIT_REFERENCE;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    ...
    if (public_boundary_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_PUBLIC_BOUNDARY |
            STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_IOKIT_RUNTIME_EXEC |
            STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_CATALOG_RUNTIME_EXEC |
            STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_PLATFORM_DRIVER_EXEC |
            STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_PUBLIC_XNU_EXEC;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }

    if (contract->no_public_pmap_exec == 1u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_PUBLIC_PMAP_EXEC;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PMAP_BOUNDARY;
    }
    ...
    if (contract->no_live_pmap_tables_installed == 0u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_LIVE_PMAP_INSTALL;
    }
    if (contract->proposed_workspace_written == 0u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_PROPOSED_PMAP_WRITE;
    }
    if (contract->pmap_ttbr_written == 0u && contract->pmap_ttbcr_written == 0u &&
        contract->pmap_dacr_written == 0u && contract->pmap_sctlr_written == 0u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_PMAP_CONTROL_WRITE;
    }
    if (contract->pmap_tlbs_invalidated == 0u && contract->caches_changed == 0u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_TLB_CACHE_CHANGE;
    }
    if (pmap_boundary_ok && contract->source_pmap_transition_status == STAGE88_STATUS_OK) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_PMAP_BOUNDARY;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_PMAP_BOUNDARY;
    }

    if (contract->xnu_start_executed == 0u && contract->generated_macho_executed == 0u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_NO_XNU_MACHO_EXEC;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    ...
    if (contract->local_only == 1u && contract->fail_closed == 1u &&
        ...
        contract->selected_personality_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->rejected_personality_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_SAT_FAIL_CLOSED;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_ROLLUP |
            STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    contract->checksum = stage88_iokit_catalog_property_dryrun_checksum(contract);
    if (contract->checksum != stage88_iokit_catalog_property_dryrun_checksum(contract)) {
        contract->failure_mask |= STAGE88_XNU_IOKIT_CATALOG_PROPERTY_DRYRUN_FAIL_CHECKSUM;
    }
...
const struct stage88_xnu_iokit_catalog_property_dryrun_contract *
stage88_xnu_iokit_catalog_property_dryrun_contract_result(void)
{
    return &g_stage88_xnu_iokit_catalog_property_dryrun_contract;
}
