#ifndef MI4IOS6_STAGE35_H
#define MI4IOS6_STAGE35_H

#include <stdint.h>
#include <stddef.h>

#define STAGE35_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage35;
...
extern struct gic_state_snapshot GIC_state_stage35;
extern volatile uint32_t stage35_irq_count;
extern volatile uint32_t stage35_last_iar;
extern volatile uint32_t stage35_last_irq_id;
extern volatile uint32_t stage35_timer_irq_count;
extern volatile uint32_t stage35_last_timer_irq_id;
...
/* stage35_main.c */
void stage35_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage35_image_end[];
extern uint8_t stage35_vectors[];
void trigger_stage35_undef_test(void) __attribute__((noreturn));
void trigger_stage35_data_abort_test(void) __attribute__((noreturn));
