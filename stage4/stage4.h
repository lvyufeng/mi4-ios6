#ifndef MI4IOS6_STAGE4_H
#define MI4IOS6_STAGE4_H

#include <stdint.h>
#include <stddef.h>

#define STAGE4_BASE          0x00008000u
...
/* stage4_main.c */
void stage4_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage4_image_end[];
extern uint8_t stage4_vectors[];
void trigger_stage4_undef_test(void) __attribute__((noreturn));
