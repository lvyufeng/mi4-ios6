...
static void build_stage70_apple_dt(struct apple_dt_builder *b)
{
    ...
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-xnu-stage70");
    apple_dt_prop_str(b, "model", "Xiaomi Mi 4 cancro Stage70");
    ...
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-cancro-stage70");
    apple_dt_prop_str(b, "IOClass", "MSM8974PlatformExpert");
    apple_dt_prop_str(b, "IOProviderClass", "IOPlatformExpertDevice");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70LocalPlatformScaffold");
    apple_dt_prop_u32(b, "IOProbeScore", STAGE70_XNU_IOKIT_MATCH_EXPECTED_PROBE_SCORE);
    ...
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-gic-stage70");
    apple_dt_prop_str(b, "IOClass", "MSM8974InterruptController");
    apple_dt_prop_str(b, "IOProviderClass", "IOPlatformExpertDevice");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70LocalInterruptService");
    apple_dt_prop_u32(b, "IOProbeScore", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_PROBE_SCORE);
    apple_dt_prop_u32_array(b, "reg", gic_reg, ARRAY_SIZE(gic_reg));
    apple_dt_prop_u32(b, "irq-count", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_EXPECTED_IRQ_COUNT_MIN);
    ...
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-timer-stage70");
    apple_dt_prop_str(b, "IOClass", "MSM8974Timer");
    apple_dt_prop_str(b, "IOProviderClass", "IOPlatformExpertDevice");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70LocalTimerService");
    apple_dt_prop_u32(b, "IOProbeScore", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_TIMER_PROBE_SCORE);
    apple_dt_prop_u32_array(b, "reg", timer_reg, ARRAY_SIZE(timer_reg));
    apple_dt_prop_u32(b, "frequency", 19200000u);
    apple_dt_prop_u32(b, "timer-ppi-mask", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_TIMER_PPI_MASK);
    apple_dt_prop_u32(b, "stage-owned-local-only", 1u);

    /* /msm8974-cpu-service: local-only CPU topology service match facts. */
    apple_dt_node_begin(b, 10, 0);
    apple_dt_prop_str(b, "name", "msm8974-cpu-service");
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-cpu-stage70");
    apple_dt_prop_str(b, "IOClass", "IOCPU");
    apple_dt_prop_str(b, "IOProviderClass", "IOPlatformExpertDevice");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70LocalCPUService");
    apple_dt_prop_u32(b, "IOProbeScore", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_CPU_PROBE_SCORE);
    ...
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-rejected-stage70");
    apple_dt_prop_str(b, "IOClass", "Stage70RejectedDriver");
    apple_dt_prop_str(b, "IOProviderClass", "IOUnknownProvider");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70RejectedLocalService");
    ...
    apple_dt_prop_u32(b, "catalog-version", STAGE70_XNU_IOKIT_CATALOG_PROPERTY_CATALOG_VERSION);
    apple_dt_prop_u32(b, "personality-count", STAGE70_XNU_IOKIT_CATALOG_PROPERTY_PERSONALITY_COUNT);
    apple_dt_prop_u32(b, "stage-owned-local-only", 1u);

    /* /stage70-platform-personality: catalog personality projected from provider-plane dry-run. */
    apple_dt_node_begin(b, 23, 0);
    apple_dt_prop_str(b, "name", "stage70-platform-personality");
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-cancro-stage70");
    apple_dt_prop_str(b, "IOClass", "MSM8974PlatformExpert");
    apple_dt_prop_str(b, "IOProviderClass", "IOPlatformExpertDevice");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70LocalPlatformScaffold");
    apple_dt_prop_u32(b, "IOProbeScore", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_PROBE_SCORE);
    apple_dt_prop_str(b, "CFBundleIdentifier", "com.mi4ios6.stage70.localcatalog");
    apple_dt_prop_u32(b, "catalog-property-dryrun", 1u);
    apple_dt_prop_u32(b, "provider-plane-published", 1u);
    apple_dt_prop_u32(b, "source-service-bit", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT);
    apple_dt_prop_u32(b, "stage-owned-local-only", 1u);
    apple_dt_prop_u32(b, "registry-entry-dryrun", 1u);
    apple_dt_prop_u32(b, "property-inheritance-dryrun", 1u);
    apple_dt_prop_u32(b, "registry-entry-ordinal", STAGE70_XNU_IOKIT_PROPERTY_INHERITANCE_PLATFORM_ORDINAL);
    apple_dt_prop_str(b, "registry-plane", "IODeviceTree");
    ...
    apple_dt_prop_str(b, "registry-entry-path", "IODeviceTree:/stage70-platform-personality");
    apple_dt_prop_u32(b, "registry-parent-ordinal", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL);
    apple_dt_prop_u32(b, "registry-sibling-order", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL);
    apple_dt_prop_str(b, "registry-topology-provenance", "stage70-property-inheritance");

    /* /stage70-interrupt-personality: catalog personality for the local interrupt service. */
    apple_dt_node_begin(b, 23, 0);
    apple_dt_prop_str(b, "name", "stage70-interrupt-personality");
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-gic-stage70");
    apple_dt_prop_str(b, "IOClass", "MSM8974InterruptController");
    apple_dt_prop_str(b, "IOProviderClass", "IOPlatformExpertDevice");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70LocalInterruptService");
    ...
    apple_dt_prop_u32(b, "catalog-property-dryrun", 1u);
    apple_dt_prop_u32(b, "provider-plane-published", 1u);
    apple_dt_prop_u32(b, "source-service-bit", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT);
    apple_dt_prop_u32(b, "stage-owned-local-only", 1u);
    apple_dt_prop_u32(b, "registry-entry-dryrun", 1u);
    apple_dt_prop_u32(b, "property-inheritance-dryrun", 1u);
    apple_dt_prop_u32(b, "registry-entry-ordinal", STAGE70_XNU_IOKIT_PROPERTY_INHERITANCE_INTERRUPT_ORDINAL);
    apple_dt_prop_str(b, "registry-plane", "IODeviceTree");
    apple_dt_prop_u32(b, "attach-deferred", 1u);
    apple_dt_prop_u32(b, "start-deferred", 1u);
    apple_dt_prop_u32(b, "registry-topology-dryrun", 1u);
    apple_dt_prop_str(b, "registry-parent-path", "IODeviceTree:/stage70-platform-personality");
    apple_dt_prop_str(b, "registry-entry-path", "IODeviceTree:/stage70-interrupt-personality");
    apple_dt_prop_u32(b, "registry-parent-ordinal", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL);
    apple_dt_prop_u32(b, "registry-sibling-order", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_INTERRUPT_ORDINAL);
    apple_dt_prop_str(b, "registry-topology-provenance", "stage70-property-inheritance");

    /* /stage70-timer-personality: catalog personality for the local timer service. */
    apple_dt_node_begin(b, 23, 0);
    apple_dt_prop_str(b, "name", "stage70-timer-personality");
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-timer-stage70");
    apple_dt_prop_str(b, "IOClass", "MSM8974Timer");
    apple_dt_prop_str(b, "IOProviderClass", "IOPlatformExpertDevice");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70LocalTimerService");
    ...
    apple_dt_prop_u32(b, "catalog-property-dryrun", 1u);
    apple_dt_prop_u32(b, "provider-plane-published", 1u);
    apple_dt_prop_u32(b, "source-service-bit", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT);
    apple_dt_prop_u32(b, "stage-owned-local-only", 1u);
    apple_dt_prop_u32(b, "registry-entry-dryrun", 1u);
    apple_dt_prop_u32(b, "property-inheritance-dryrun", 1u);
    apple_dt_prop_u32(b, "registry-entry-ordinal", STAGE70_XNU_IOKIT_PROPERTY_INHERITANCE_TIMER_ORDINAL);
    apple_dt_prop_str(b, "registry-plane", "IODeviceTree");
    apple_dt_prop_u32(b, "attach-deferred", 1u);
    apple_dt_prop_u32(b, "start-deferred", 1u);
    apple_dt_prop_u32(b, "registry-topology-dryrun", 1u);
    apple_dt_prop_str(b, "registry-parent-path", "IODeviceTree:/stage70-platform-personality");
    apple_dt_prop_str(b, "registry-entry-path", "IODeviceTree:/stage70-timer-personality");
    apple_dt_prop_u32(b, "registry-parent-ordinal", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL);
    apple_dt_prop_u32(b, "registry-sibling-order", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_TIMER_ORDINAL);
    apple_dt_prop_str(b, "registry-topology-provenance", "stage70-property-inheritance");

    /* /stage70-cpu-personality: catalog personality for the local CPU service. */
    apple_dt_node_begin(b, 23, 0);
    apple_dt_prop_str(b, "name", "stage70-cpu-personality");
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-cpu-stage70");
    apple_dt_prop_str(b, "IOClass", "IOCPU");
    apple_dt_prop_str(b, "IOProviderClass", "IOPlatformExpertDevice");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70LocalCPUService");
    ...
    apple_dt_prop_u32(b, "catalog-property-dryrun", 1u);
    apple_dt_prop_u32(b, "provider-plane-published", 1u);
    apple_dt_prop_u32(b, "source-service-bit", STAGE70_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT);
    apple_dt_prop_u32(b, "stage-owned-local-only", 1u);
    apple_dt_prop_u32(b, "registry-entry-dryrun", 1u);
    apple_dt_prop_u32(b, "property-inheritance-dryrun", 1u);
    apple_dt_prop_u32(b, "registry-entry-ordinal", STAGE70_XNU_IOKIT_PROPERTY_INHERITANCE_CPU_ORDINAL);
    apple_dt_prop_str(b, "registry-plane", "IODeviceTree");
    apple_dt_prop_u32(b, "attach-deferred", 1u);
    apple_dt_prop_u32(b, "start-deferred", 1u);
    apple_dt_prop_u32(b, "registry-topology-dryrun", 1u);
    apple_dt_prop_str(b, "registry-parent-path", "IODeviceTree:/stage70-platform-personality");
    apple_dt_prop_str(b, "registry-entry-path", "IODeviceTree:/stage70-cpu-personality");
    apple_dt_prop_u32(b, "registry-parent-ordinal", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL);
    apple_dt_prop_u32(b, "registry-sibling-order", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_CPU_ORDINAL);
    apple_dt_prop_str(b, "registry-topology-provenance", "stage70-property-inheritance");

    /* /stage70-rejected-personality: negative catalog personality remains unpublished. */
    apple_dt_node_begin(b, 22, 0);
    apple_dt_prop_str(b, "name", "stage70-rejected-personality");
    apple_dt_prop_str(b, "compatible", "qcom,msm8974-rejected-stage70");
    apple_dt_prop_str(b, "IOClass", "Stage70RejectedDriver");
    apple_dt_prop_str(b, "IOProviderClass", "IOUnknownProvider");
    apple_dt_prop_str(b, "IOMatchCategory", "Stage70RejectedLocalService");
    ...
    apple_dt_prop_u32(b, "property-inheritance-dryrun", 1u);
    apple_dt_prop_u32(b, "registry-entry-ordinal", STAGE70_XNU_IOKIT_PROPERTY_INHERITANCE_REJECTED_ORDINAL);
    ...
    apple_dt_prop_str(b, "registry-entry-path", "IODeviceTree:/stage70-rejected-personality");
    apple_dt_prop_u32(b, "registry-parent-ordinal", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL);
    apple_dt_prop_u32(b, "registry-sibling-order", STAGE70_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL);
    apple_dt_prop_str(b, "registry-topology-provenance", "stage70-rejected-unlinked");
    apple_dt_prop_u32(b, "registry-entry-linked", 0u);

    /* /chosen */
    apple_dt_node_begin(b, 4, 0);
    apple_dt_prop_str(b, "name", "chosen");
    apple_dt_prop_str(b, "boot-args", "debug=0x144 serial=0x1 mi4ios6.stage=70 xnu-cg xnu-bs xnu-pmap-bs pexpert-hook-ready iokit-platform-scaffold iokit-match-dryrun iokit-regsvc-dryrun iokit-provider-dryrun iokit-catalog-dryrun iokit-propinh-dryrun iokit-regtop-dryrun pmap-ref st70dt=0x70");
...
{
    log_puts("MI4IOS6_STAGE70 handoff -> test_kernel_entry(boot_args*)\n");

    if (!args) {
        log_puts("MI4IOS6_STAGE70 handoff bad: null args\n");
        return 0;
    }
    ...
    if (args->Revision != BOOT_ARGS_REVISION || args->Version != BOOT_ARGS_VERSION) {
        log_puts("MI4IOS6_STAGE70 handoff bad: rev/version\n");
        return 0;
    }
    if (!args->deviceTreeP || !args->deviceTreeLength) {
        log_puts("MI4IOS6_STAGE70 handoff bad: no dt\n");
        return 0;
    }

    if (!apple_dt_selftest_and_log(args->deviceTreeP, args->deviceTreeLength)) {
        log_puts("MI4IOS6_STAGE70 handoff bad: dt selftest\n");
        return 0;
    }

    log_puts("MI4IOS6_STAGE70 handoff ok: boot_args + fuller apple_dt validated\n");
    return 1;
}
...
void platform_reboot(void)
{
    ...
    *restart_reason = RESTART_NORMAL;
    ...
    log_puts("MI4IOS6_STAGE70 attempting MSM8974 PS_HOLD reset\n");
    *ps_hold = 0;
    __asm__ volatile ("dsb sy" ::: "memory");
...
void stage70_main(void)
{
    struct apple_dt_builder b;
    uint32_t dt_len;

    log_init();
    log_puts("MI4IOS6_STAGE70 v1 entered; public-XNU pexpert/platform graph + bounded ARM pe_bootargs link proof scaffold; ram_console live\n");
    log_kv32("stage70_image_end", (uint32_t)(uintptr_t)__stage70_image_end);

    build_stage70_apple_dt(&b);
    dt_len = apple_dt_finish(&b);
    log_kv32("built_apple_dt_len", dt_len);

    if (!dt_len) {
        log_puts("MI4IOS6_STAGE70 apple_dt build failed\n");
        platform_reboot();
    }

    build_boot_args(&g_boot_args, g_apple_dt, dt_len);
    log_puts("MI4IOS6_STAGE70 boot_args built (rev2); fuller apple_dt attached\n");

    log_puts("MI4IOS6_STAGE70 vector base installed at ");
    log_hex32((uint32_t)(uintptr_t)stage70_vectors);
    log_puts("\n");

    log_puts("MI4IOS6_STAGE70 boot-wrapper handoff -> kernel_entry(boot_args*)\n");
    if (kernel_entry(&g_boot_args)) {
        log_puts("MI4IOS6_STAGE70 kernel_entry returned success\n");
    } else {
        log_puts("MI4IOS6_STAGE70 kernel_entry returned failure\n");
        platform_reboot();
    }
