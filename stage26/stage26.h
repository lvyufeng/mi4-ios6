#ifndef MI4IOS6_STAGE26_H
#define MI4IOS6_STAGE26_H

#include <stdint.h>
#include <stddef.h>

#define STAGE26_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage26;
...
extern struct gic_state_snapshot GIC_state_stage26;
extern volatile uint32_t stage26_irq_count;
extern volatile uint32_t stage26_last_iar;
extern volatile uint32_t stage26_last_irq_id;
extern volatile uint32_t stage26_timer_irq_count;
extern volatile uint32_t stage26_last_timer_irq_id;
...
/* stage26_main.c */
void stage26_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage26_image_end[];
extern uint8_t stage26_vectors[];
void trigger_stage26_undef_test(void) __attribute__((noreturn));
void trigger_stage26_data_abort_test(void) __attribute__((noreturn));
