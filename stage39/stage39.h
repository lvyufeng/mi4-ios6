#ifndef MI4IOS6_STAGE39_H
#define MI4IOS6_STAGE39_H

#include <stdint.h>
#include <stddef.h>

#define STAGE39_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage39;
...
extern struct gic_state_snapshot GIC_state_stage39;
extern volatile uint32_t stage39_irq_count;
extern volatile uint32_t stage39_last_iar;
extern volatile uint32_t stage39_last_irq_id;
extern volatile uint32_t stage39_timer_irq_count;
extern volatile uint32_t stage39_last_timer_irq_id;
...
/* stage39_main.c */
void stage39_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage39_image_end[];
extern uint8_t stage39_vectors[];
void trigger_stage39_undef_test(void) __attribute__((noreturn));
void trigger_stage39_data_abort_test(void) __attribute__((noreturn));
