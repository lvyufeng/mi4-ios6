#ifndef MI4IOS6_STAGE31_H
#define MI4IOS6_STAGE31_H

#include <stdint.h>
#include <stddef.h>

#define STAGE31_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage31;
...
extern struct gic_state_snapshot GIC_state_stage31;
extern volatile uint32_t stage31_irq_count;
extern volatile uint32_t stage31_last_iar;
extern volatile uint32_t stage31_last_irq_id;
extern volatile uint32_t stage31_timer_irq_count;
extern volatile uint32_t stage31_last_timer_irq_id;
...
/* stage31_main.c */
void stage31_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage31_image_end[];
extern uint8_t stage31_vectors[];
void trigger_stage31_undef_test(void) __attribute__((noreturn));
void trigger_stage31_data_abort_test(void) __attribute__((noreturn));
