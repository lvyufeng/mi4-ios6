...
static struct stage84_gic_irq_state {
...
void stage84_gic_irq_init(void)
{
	...
	*gicc_pmr = 0xff;
	...
	g_gic_irq_state.init_status = STAGE84_STATUS_OK;
}

void stage84_gic_irq_enable_interrupt(uint32_t irq_id)
{
...
const struct stage84_gic_irq_state *stage84_gic_irq_state(void)
{
