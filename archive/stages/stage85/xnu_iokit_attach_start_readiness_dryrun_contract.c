...
static struct stage85_xnu_iokit_attach_start_readiness_dryrun_contract
    g_stage85_xnu_iokit_attach_start_readiness_dryrun_contract;

static uint32_t stage85_iokit_attach_start_readiness_dryrun_checksum(
    volatile const struct stage85_xnu_iokit_attach_start_readiness_dryrun_contract *contract)
{
    volatile const uint32_t *words = (volatile const uint32_t *)(uintptr_t)contract;
    uint32_t count = (uint32_t)(offsetof(struct stage85_xnu_iokit_attach_start_readiness_dryrun_contract,
...
static void stage85_iokit_attach_start_readiness_dryrun_log(
    const struct stage85_xnu_iokit_attach_start_readiness_dryrun_contract *contract)
{
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_dryrun_contract_status", contract->status);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_dryrun_contract_required_mask", contract->required_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_dryrun_contract_satisfied_mask", contract->satisfied_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_dryrun_contract_failure_mask", contract->failure_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_dryrun_contract_checksum", contract->checksum);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_topology_status", contract->source_topology_status);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_topology_satisfied_mask", contract->source_topology_satisfied_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_topology_failure_mask", contract->source_topology_failure_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_topology_checksum", contract->source_topology_checksum);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_topology_dryrun_checksum", contract->source_topology_topology_checksum);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_selected_topology_entry_mask", contract->source_selected_topology_entry_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_rejected_unlinked_mask", contract->source_rejected_unlinked_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_topology_matrix", contract->source_topology_matrix);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_apple_dt_semantic_mask", contract->apple_dt_semantic_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_platform_props", contract->platform_personality_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_interrupt_props", contract->interrupt_personality_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_timer_props", contract->timer_personality_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_cpu_props", contract->cpu_personality_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_rejected_props", contract->rejected_personality_prop_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_attach_readiness_mask", contract->attach_readiness_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_start_readiness_mask", contract->start_readiness_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_attach_provider_path_match_mask", contract->attach_provider_path_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_start_provider_path_match_mask", contract->start_provider_path_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_attach_provider_ordinal_match_mask", contract->attach_provider_ordinal_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_start_provider_ordinal_match_mask", contract->start_provider_ordinal_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_attach_order_match_mask", contract->attach_order_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_start_order_match_mask", contract->start_order_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_provider_start_required_mask", contract->provider_start_required_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_provider_start_satisfied_mask", contract->provider_start_satisfied_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_attach_runtime_blocked_mask", contract->attach_runtime_blocked_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_start_runtime_blocked_mask", contract->start_runtime_blocked_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_provenance_match_mask", contract->attach_start_provenance_match_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_attach_deferred_mask", contract->source_attach_deferred_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_source_start_deferred_mask", contract->source_start_deferred_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_selected_attach_start_entry_mask", contract->selected_attach_start_entry_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_rejected_attach_start_mask", contract->rejected_attach_start_mask);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_attach_start_matrix", contract->attach_start_matrix);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_attach_order_checksum", contract->attach_order_checksum);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_start_order_checksum", contract->start_order_checksum);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_path_hash", contract->attach_start_path_hash);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_checksum", contract->attach_start_checksum);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_expected_checksum", contract->expected_attach_start_checksum);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_candidate_count", contract->attach_start_candidate_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_selected_entry_count", contract->selected_attach_start_entry_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_rejected_entry_count", contract->rejected_attach_start_entry_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_attach_count", contract->attach_readiness_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_start_count", contract->start_readiness_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_provider_required_count", contract->provider_start_required_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_provider_satisfied_count", contract->provider_start_satisfied_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_rejected_unattached_unstarted_count", contract->rejected_unattached_unstarted_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_public_compile_count", contract->iokit_public_compile_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_public_link_count", contract->iokit_public_link_count);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_no_iokit_runtime_exec", contract->no_iokit_runtime_exec);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_no_registry_topology_runtime_exec", contract->no_registry_topology_runtime_exec);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_no_attach_runtime_exec", contract->no_attach_runtime_exec);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_no_start_runtime_exec", contract->no_start_runtime_exec);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_no_live_pmap_tables_installed", contract->no_live_pmap_tables_installed);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_proposed_workspace_written", contract->proposed_workspace_written);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_pmap_ttbr_written", contract->pmap_ttbr_written);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_pmap_tlbs_invalidated", contract->pmap_tlbs_invalidated);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_caches_changed", contract->caches_changed);
    xnu_log_kv32("stage85_xnu_iokit_attach_start_readiness_persistent_write_attempted", contract->persistent_write_attempted);
}
...
static void selected_masks_for_node(const struct boot_args *args, const void *node, uint32_t bit,
                                    ...
                                    struct stage85_xnu_iokit_attach_start_readiness_dryrun_contract *contract)
{
    ...
    if (string_prop_equals(args, node, "attach-start-provenance", "stage85-registry-topology")) {
        contract->attach_start_provenance_match_mask |= bit;
    }
}

int stage85_xnu_iokit_attach_start_readiness_dryrun_contract_selftest(
    const struct stage85_loader_preflight *preflight)
{
    ...
    contract->version = STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_CONTRACT_VERSION;
    contract->size = sizeof(*contract);
    contract->status = STAGE85_STATUS_BASE;
    contract->required_mask = STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_REQUIRED_MASK;

    if (!preflight || !args || !root) {
        contract->failure_mask = STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_SOURCE |
            STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_SAFETY_BOUNDARY;
        contract->checksum = stage85_iokit_attach_start_readiness_dryrun_checksum(contract);
        stage85_iokit_attach_start_readiness_dryrun_log(contract);
        return 0;
    }
    ...
    if (u32_prop_equals(args, rejected_node, "attach-start-readiness-dryrun", 0u) &&
        ...
        u32_prop_equals(args, rejected_node, "start-provider-ordinal",
                        STAGE85_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "attach-order", STAGE85_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "start-order", STAGE85_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "provider-start-required", 0u) &&
        string_prop_equals(args, rejected_node, "attach-start-provenance", "stage85-rejected-unattached") &&
        ...
        contract->rejected_attach_start_mask |= STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    ...
    contract->attach_start_path_hash = STAGE85_XNU_IOKIT_ATTACH_START_READINESS_PATH_HASH;
    contract->attach_start_candidate_count = STAGE85_XNU_IOKIT_ATTACH_START_READINESS_CANDIDATE_COUNT;
    contract->selected_attach_start_entry_count = (contract->selected_attach_start_entry_mask ==
        ...
        STAGE85_XNU_IOKIT_ATTACH_START_READINESS_ENTRY_COUNT : 0u;
    contract->rejected_attach_start_entry_count = (contract->rejected_attach_start_mask ==
        ...
        STAGE85_XNU_IOKIT_ATTACH_START_READINESS_REJECTED_COUNT : 0u;
    ...
    contract->expected_attach_start_checksum = STAGE85_XNU_IOKIT_ATTACH_START_READINESS_EXPECTED_CHECKSUM;
    ...
    source_ok = (contract->source_topology_status == STAGE85_STATUS_OK &&
                 contract->source_topology_satisfied_mask == STAGE85_XNU_IOKIT_REGISTRY_TOPOLOGY_DRYRUN_REQUIRED_MASK &&
                 contract->source_topology_failure_mask == 0u &&
                 contract->source_topology_topology_checksum == STAGE85_XNU_IOKIT_REGISTRY_TOPOLOGY_EXPECTED_TOPOLOGY_CHECKSUM &&
                 contract->source_selected_topology_entry_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_rejected_unlinked_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
                 contract->source_topology_matrix == (STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                                      STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) &&
    ...
    if (source_ok) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_SOURCE_TOPOLOGY;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_SOURCE;
    }

    if (contract->apple_dt_semantic_mask == STAGE85_DT_READY_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_APPLE_DT;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_DT;
    }
    ...
    if (personality_nodes_ok) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_PERSONALITY_NODE_SET;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PERSONALITY;
    }

    if (contract->attach_readiness_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_ATTACH_READINESS_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_ATTACH;
    }
    if (contract->start_readiness_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_START_READINESS_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_START;
    }
    if (contract->attach_provider_path_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_ATTACH_PROVIDER_PATH_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PROVIDER;
    }
    if (contract->start_provider_path_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_START_PROVIDER_PATH_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PROVIDER;
    }
    if (contract->attach_provider_ordinal_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_ATTACH_PROVIDER_ORDINAL_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PROVIDER;
    }
    if (contract->start_provider_ordinal_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_START_PROVIDER_ORDINAL_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PROVIDER;
    }
    if (contract->attach_order_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->attach_order_checksum == STAGE85_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_ATTACH_ORDER_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_ORDER;
    }
    if (contract->start_order_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->start_order_checksum == STAGE85_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_START_ORDER_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_ORDER;
    }
    if (contract->provider_start_required_mask == (STAGE85_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT |
                                                  STAGE85_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT |
                                                  STAGE85_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT) &&
        contract->provider_start_satisfied_mask == (STAGE85_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT |
                                                   STAGE85_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT |
                                                   STAGE85_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT) &&
        contract->provider_start_required_count == 3u && contract->provider_start_satisfied_count == 3u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_PROVIDER_START_DEPENDENCY;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_ORDER;
    }
    if (contract->source_attach_deferred_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->source_start_deferred_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_SOURCE_DEFERRED;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_SOURCE;
    }
    if (contract->selected_attach_start_entry_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->attach_runtime_blocked_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->start_runtime_blocked_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->attach_start_provenance_match_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_SELECTED_ATTACH_START_MATRIX;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_ATTACH |
            STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_START;
    }
    if (contract->rejected_attach_start_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->source_rejected_unlinked_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->rejected_unattached_unstarted_count == STAGE85_XNU_IOKIT_ATTACH_START_READINESS_REJECTED_COUNT) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_REJECT_UNATTACHED_UNSTARTED;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_REJECTED;
    }
    if (contract->attach_start_candidate_count == STAGE85_XNU_IOKIT_ATTACH_START_READINESS_CANDIDATE_COUNT &&
        contract->selected_attach_start_entry_count == STAGE85_XNU_IOKIT_ATTACH_START_READINESS_ENTRY_COUNT &&
        contract->rejected_attach_start_entry_count == STAGE85_XNU_IOKIT_ATTACH_START_READINESS_REJECTED_COUNT &&
        contract->attach_readiness_count == STAGE85_XNU_IOKIT_ATTACH_START_READINESS_ENTRY_COUNT &&
        contract->start_readiness_count == STAGE85_XNU_IOKIT_ATTACH_START_READINESS_ENTRY_COUNT &&
        contract->attach_start_matrix == (STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                          STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_DRYRUN_COUNTS;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_COUNTS;
    }
    if (contract->attach_start_checksum == contract->expected_attach_start_checksum) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_ATTACH_START_CHECKSUM;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_CHECKSUM;
    }
    ...
    if (contract->iokit_reference_mask == STAGE85_XNU_IOKIT_REFERENCE_REQUIRED &&
        ...
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_IOKIT_REFERENCE;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    ...
    if (public_boundary_ok) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_PUBLIC_BOUNDARY |
            STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_IOKIT_RUNTIME_EXEC |
            STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_ATTACH_RUNTIME_EXEC |
            STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_START_RUNTIME_EXEC |
            STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_REGISTRY_TOPOLOGY_RUNTIME_EXEC |
            STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_PUBLIC_XNU_EXEC;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }

    if (contract->no_public_pmap_exec == 1u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_PUBLIC_PMAP_EXEC;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PMAP_BOUNDARY;
    }
    ...
    if (contract->no_live_pmap_tables_installed == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_LIVE_PMAP_INSTALL;
    }
    if (contract->pmap_tlbs_invalidated == 0u && contract->caches_changed == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_TLB_CACHE_CHANGE;
    }
    if (pmap_boundary_ok && contract->source_pmap_transition_status == STAGE85_STATUS_OK) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_PMAP_BOUNDARY;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_PMAP_BOUNDARY;
    }

    if (contract->generated_macho_executed == 0u && contract->xnu_start_executed == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_XNU_MACHO_EXEC;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->persistent_write_attempted == 0u) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_NO_PERSIST_WRITE;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->local_only == 1u && contract->fail_closed == 1u &&
        ...
        contract->selected_attach_start_entry_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->rejected_attach_start_mask == STAGE85_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_SAT_LOCAL_ONLY_FAIL_CLOSED;
    } else {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_ROLLUP |
            STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    contract->checksum = stage85_iokit_attach_start_readiness_dryrun_checksum(contract);
    if (contract->checksum != stage85_iokit_attach_start_readiness_dryrun_checksum(contract)) {
        contract->failure_mask |= STAGE85_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_FAIL_CHECKSUM;
    }
...
const struct stage85_xnu_iokit_attach_start_readiness_dryrun_contract *
stage85_xnu_iokit_attach_start_readiness_dryrun_contract_result(void)
{
    return &g_stage85_xnu_iokit_attach_start_readiness_dryrun_contract;
}
