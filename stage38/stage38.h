#ifndef MI4IOS6_STAGE38_H
#define MI4IOS6_STAGE38_H

#include <stdint.h>
#include <stddef.h>

#define STAGE38_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage38;
...
extern struct gic_state_snapshot GIC_state_stage38;
extern volatile uint32_t stage38_irq_count;
extern volatile uint32_t stage38_last_iar;
extern volatile uint32_t stage38_last_irq_id;
extern volatile uint32_t stage38_timer_irq_count;
extern volatile uint32_t stage38_last_timer_irq_id;
...
/* stage38_main.c */
void stage38_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage38_image_end[];
extern uint8_t stage38_vectors[];
void trigger_stage38_undef_test(void) __attribute__((noreturn));
void trigger_stage38_data_abort_test(void) __attribute__((noreturn));
