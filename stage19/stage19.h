#ifndef MI4IOS6_STAGE19_H
#define MI4IOS6_STAGE19_H

#include <stdint.h>
#include <stddef.h>

#define STAGE19_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage19;
...
extern struct gic_state_snapshot GIC_state_stage19;
extern volatile uint32_t stage19_irq_count;
extern volatile uint32_t stage19_last_iar;
extern volatile uint32_t stage19_last_irq_id;
extern volatile uint32_t stage19_timer_irq_count;
extern volatile uint32_t stage19_last_timer_irq_id;
...
/* stage19_main.c */
void stage19_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage19_image_end[];
extern uint8_t stage19_vectors[];
void trigger_stage19_undef_test(void) __attribute__((noreturn));
void trigger_stage19_data_abort_test(void) __attribute__((noreturn));
