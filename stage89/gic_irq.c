...
static struct stage89_gic_irq_state {
...
void stage89_gic_irq_init(void)
{
	...
	*gicc_pmr = 0xff;
	...
	g_gic_irq_state.init_status = STAGE89_STATUS_OK;
}

void stage89_gic_irq_enable_interrupt(uint32_t irq_id)
{
...
const struct stage89_gic_irq_state *stage89_gic_irq_state(void)
{
