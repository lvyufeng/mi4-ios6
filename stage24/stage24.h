#ifndef MI4IOS6_STAGE24_H
#define MI4IOS6_STAGE24_H

#include <stdint.h>
#include <stddef.h>

#define STAGE24_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage24;
...
extern struct gic_state_snapshot GIC_state_stage24;
extern volatile uint32_t stage24_irq_count;
extern volatile uint32_t stage24_last_iar;
extern volatile uint32_t stage24_last_irq_id;
extern volatile uint32_t stage24_timer_irq_count;
extern volatile uint32_t stage24_last_timer_irq_id;
...
/* stage24_main.c */
void stage24_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage24_image_end[];
extern uint8_t stage24_vectors[];
void trigger_stage24_undef_test(void) __attribute__((noreturn));
void trigger_stage24_data_abort_test(void) __attribute__((noreturn));
