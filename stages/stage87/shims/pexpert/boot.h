#ifndef MI4IOS6_STAGE87_SHIM_PEXPERT_BOOT_H
#define MI4IOS6_STAGE87_SHIM_PEXPERT_BOOT_H
 ...
 * Stage84 payload continues to use its own stage87.h boot_args structure and
