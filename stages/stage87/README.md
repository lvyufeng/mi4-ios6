...
- **Status**: `loader_status=0x87000001` (OK)
- **IRQ window status**: `stage87_xnu_arm_vm_init_irq_window_status=0x87000001` (OK)
...
```bash
cd /mnt/data/mi4-ios6/stage87
./build.sh
```

Artifacts:
- `out/stage87/stage87.elf` (507KB)
- `out/stage87/stage87.bin` (454KB)
- `out/stage87/stage87-qcdt.img` (2.9MB, includes QCDT device tree)
...
sudo adb -s 4a2fe00b exec-out 'cat /proc/last_kmsg' > /tmp/stage87-last_kmsg.txt
```

Expected pass markers:
```
stage87_xnu_arm_vm_init_irq_window_status=0x87000001
stage87_xnu_arm_vm_init_irq_window_satisfied_mask=0x00003fff
stage87_xnu_arm_vm_init_irq_window_failure_mask=0x00000000
stage87_xnu_arm_vm_init_irq_window_gic_configured=0x00000001
stage87_xnu_arm_vm_init_irq_window_timer_configured=0x00000001
stage87_xnu_arm_vm_init_irq_window_irq_enabled=0x00000001
stage87_xnu_arm_vm_init_irq_window_timer_irq_delivered=0x00000001
stage87_xnu_arm_vm_init_irq_window_irq_handled=0x00000001
...
- Planning: `docs/stage87-sgi-irq-timer-planning.md`
- Hardware validation: `docs/experiment-87-stage87-sgi-irq-timer.md` (to be created)
