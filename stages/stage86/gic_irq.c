...
static struct stage86_gic_irq_state {
...
void stage86_gic_irq_init(void)
{
	...
	*gicc_pmr = 0xff;
	...
	g_gic_irq_state.init_status = STAGE86_STATUS_OK;
}

void stage86_gic_irq_enable_interrupt(uint32_t irq_id)
{
...
const struct stage86_gic_irq_state *stage86_gic_irq_state(void)
{
