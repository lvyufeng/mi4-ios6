...
#define STAGE90_XNU_SHIM_KALLOC_BYTES   4096u
#define STAGE90_XNU_CONSISTENT_DEBUG_WINDOW_BYTES 0x4000u

void *memset(void *dst, int c, size_t n);

static boot_args g_stage90_xnu_public_arm_boot_args = {
...
PE_state_t PE_state = {
    ...
    .video = {0},
    .deviceTreeHead = NULL,
    .bootArgs = &g_stage90_xnu_public_arm_boot_args,
};

static uint8_t g_stage90_xnu_shim_kalloc[STAGE90_XNU_SHIM_KALLOC_BYTES];
static vm_size_t g_stage90_xnu_shim_kalloc_used;
static uint8_t g_stage90_xnu_consistent_debug_window[STAGE90_XNU_CONSISTENT_DEBUG_WINDOW_BYTES] __attribute__((aligned(8)));
...
void *kalloc(vm_size_t size)
{
    ...
    if (aligned_size == 0u || aligned_size > (STAGE90_XNU_SHIM_KALLOC_BYTES - g_stage90_xnu_shim_kalloc_used)) {
        return NULL;
    }

    ptr = &g_stage90_xnu_shim_kalloc[g_stage90_xnu_shim_kalloc_used];
    g_stage90_xnu_shim_kalloc_used += aligned_size;
    memset(ptr, 0, size);
    return ptr;
}
