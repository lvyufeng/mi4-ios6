...
PLAN_TXT="$OUT_DIR/stage90-object-plan.txt"
...
printf 'stage90_xnu_workspace_status=0x%08x\n' "$status" >> "$STATUS_TXT"
printf 'stage90_xnu_workspace_required_mask=0x%08x\n' 0x0007ffff >> "$STATUS_TXT"
printf 'stage90_xnu_workspace_satisfied_mask=0x%08x\n' "$satisfied" >> "$STATUS_TXT"
printf 'stage90_xnu_workspace_failure_mask=0x%08x\n' "$failure" >> "$STATUS_TXT"
printf 'stage90_xnu_baseline_commit32=0xcc8a9b0c\n' >> "$STATUS_TXT"
printf 'stage90_xnu_master_version=0x000c0300\n' >> "$STATUS_TXT"
printf 'stage90_xnu_arm_reference=0x45700146\n' >> "$STATUS_TXT"
printf 'stage90_target_cancro=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_target_armv7=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_target_msm8974=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_public_2050_arm_gap_recorded=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_stage90_plan_ready=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_no_full_xnu_build=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_no_xnu_exec=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_no_macho_exec=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_no_proposed_phys_write=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_no_proposed_tte_write=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_no_cache_change=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_no_persist_write=0x00000001\n' >> "$STATUS_TXT"
printf 'stage90_external_checkout_mutated=0x00000000\n' >> "$STATUS_TXT"

cat > "$HEADER" <<EOF_HEADER
#ifndef MI4IOS6_STAGE90_XNU_WORKSPACE_GENERATED_H
#define MI4IOS6_STAGE90_XNU_WORKSPACE_GENERATED_H

#define STAGE90_XNU_WS_HOST_STATUS              0x$(printf '%08x' "$status")u
#define STAGE90_XNU_WS_HOST_REQUIRED_MASK       0x0007ffffu
#define STAGE90_XNU_WS_HOST_SATISFIED_MASK      0x$(printf '%08x' "$satisfied")u
#define STAGE90_XNU_WS_HOST_FAILURE_MASK        0x$(printf '%08x' "$failure")u
#define STAGE90_XNU_WS_BASELINE_COMMIT32        0xcc8a9b0cu
#define STAGE90_XNU_WS_MASTER_VERSION_12_3_0    0x000c0300u
#define STAGE90_XNU_WS_ARM_REFERENCE_4570_1_46  0x45700146u
#define STAGE90_XNU_WS_HOST_TARGET_CANCRO            1u
#define STAGE90_XNU_WS_HOST_TARGET_ARMV7             1u
#define STAGE90_XNU_WS_HOST_TARGET_MSM8974           1u
#define STAGE90_XNU_WS_HOST_PUBLIC_ONLY              1u
#define STAGE90_XNU_WS_HOST_NO_FULL_XNU_BUILD        1u
#define STAGE90_XNU_WS_HOST_NO_XNU_EXEC              1u
#define STAGE90_XNU_WS_HOST_NO_MACHO_EXEC            1u
#define STAGE90_XNU_WS_HOST_NO_PROPOSED_PHYS_WRITE   1u
#define STAGE90_XNU_WS_HOST_NO_PROPOSED_TTE_WRITE    1u
#define STAGE90_XNU_WS_HOST_NO_CACHE_CHANGE          1u
#define STAGE90_XNU_WS_HOST_NO_PERSIST_WRITE         1u
#define STAGE90_XNU_WS_HOST_STAGE90_PLAN_READY       1u
#define STAGE90_XNU_WS_HOST_ARM_GAP_RECORDED         1u
#define STAGE90_XNU_WS_HOST_EXTERNAL_MUTATED         0u
