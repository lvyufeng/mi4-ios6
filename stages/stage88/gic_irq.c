...
static struct stage88_gic_irq_state {
...
void stage88_gic_irq_init(void)
{
	...
	*gicc_pmr = 0xff;
	...
	g_gic_irq_state.init_status = STAGE88_STATUS_OK;
}

void stage88_gic_irq_enable_interrupt(uint32_t irq_id)
{
...
const struct stage88_gic_irq_state *stage88_gic_irq_state(void)
{
