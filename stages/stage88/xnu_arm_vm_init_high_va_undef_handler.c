...
static struct stage88_xnu_arm_vm_init_high_va_undef_handler_result g_result;

static uint32_t stage88_xnu_arm_vm_init_high_va_undef_handler_checksum(
    volatile const struct stage88_xnu_arm_vm_init_high_va_undef_handler_result *r)
{
	volatile const uint32_t *words = (volatile const uint32_t *)r;
	uint32_t count = (uint32_t)(offsetof(struct stage88_xnu_arm_vm_init_high_va_undef_handler_result, checksum) / sizeof(uint32_t));
	uint32_t chk = 0;
...
static void stage88_xnu_arm_vm_init_high_va_undef_handler_log(
    volatile const struct stage88_xnu_arm_vm_init_high_va_undef_handler_result *r)
{
	xnu_log_puts("stage88_xnu_arm_vm_init_high_va_undef_handler result:\n");
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_version", r->version);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_size", r->size);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_status", r->status);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_required_mask", r->required_mask);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_satisfied_mask", r->satisfied_mask);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_failure_mask", r->failure_mask);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_full_pmap_status", r->full_pmap_status);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_vectors_phys", r->vectors_phys);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_vectors_high_va", r->vectors_high_va);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_original_vbar", r->original_vbar);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_high_va_vbar_set", r->high_va_vbar_set);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_undef_triggered", r->undef_triggered);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_undef_handled", r->undef_handled);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_undef_count", r->undef_count);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_undef_last_addr", r->undef_last_addr);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_undef_addr_valid", r->undef_addr_valid);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_vbar_restored", r->vbar_restored);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_restored_vbar", r->restored_vbar);
	xnu_log_kv32("stage88_xnu_arm_vm_init_high_va_undef_handler_checksum", r->checksum);
}
...
{
	struct stage88_xnu_arm_vm_init_high_va_undef_handler_result *r = &g_result;
	...
	/* Initialize result */
	memset(r, 0, sizeof(*r));
	r->version = STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_VERSION;
	r->size = sizeof(*r);
	r->required_mask = STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_REQUIRED_MASK;
	...
	if (!pmap_result || pmap_result->status != STAGE88_STATUS_OK) {
		r->failure_mask |= STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_FAIL_FULL_PMAP;
		goto finish;
	}
	r->full_pmap_status = pmap_result->status;
	r->satisfied_mask |= STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_SAT_FULL_PMAP_OK;
	...
	r->satisfied_mask |= STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_SAT_VBAR_SET;
	...
	r->undef_triggered = 1;
	r->satisfied_mask |= STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_SAT_UNDEF_TRIGGERED;

	/* Verify exception was handled */
	if (g_undef_handled) {
		r->undef_handled = 1;
		r->satisfied_mask |= STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_SAT_UNDEF_HANDLED;
	} else {
		r->failure_mask |= STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_FAIL_UNDEF_NOT_HANDLED;
	}
	...
	if (g_undef_last_addr >= undef_instr_addr_before &&
		...
		r->satisfied_mask |= STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_SAT_UNDEF_ADDR_VALID;
	}
	...
	r->satisfied_mask |= STAGE88_XNU_ARM_VM_INIT_HIGH_VA_UNDEF_HANDLER_SAT_VBAR_RESTORED;
...
finish:
	...
	/* Compute checksum */
	r->checksum = stage88_xnu_arm_vm_init_high_va_undef_handler_checksum(r);

	/* Log result */
	stage88_xnu_arm_vm_init_high_va_undef_handler_log(r);

	return r->status == STAGE88_STATUS_OK ? 0 : -1;
}

const struct stage88_xnu_arm_vm_init_high_va_undef_handler_result *
stage88_xnu_arm_vm_init_high_va_undef_handler_result(void)
{
	return &g_result;
}
