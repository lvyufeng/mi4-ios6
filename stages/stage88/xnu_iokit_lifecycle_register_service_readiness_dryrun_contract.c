...
static struct stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract
    g_stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract;

static uint32_t stage88_iokit_lifecycle_register_service_dryrun_checksum(
    volatile const struct stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract *contract)
{
    volatile const uint32_t *words = (volatile const uint32_t *)(uintptr_t)contract;
    uint32_t count = (uint32_t)(offsetof(struct stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract,
...
static void stage88_iokit_lifecycle_register_service_dryrun_log(
    const struct stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract *contract)
{
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract_status", contract->status);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract_required_mask", contract->required_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract_satisfied_mask", contract->satisfied_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract_failure_mask", contract->failure_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract_checksum", contract->checksum);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_source_attach_start_status", contract->source_attach_start_status);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_source_attach_start_satisfied_mask", contract->source_attach_start_satisfied_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_source_attach_start_failure_mask", contract->source_attach_start_failure_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_source_attach_start_checksum", contract->source_attach_start_checksum);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_source_selected_attach_start_entry_mask", contract->source_selected_attach_start_entry_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_source_rejected_attach_start_mask", contract->source_rejected_attach_start_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_source_attach_start_matrix", contract->source_attach_start_matrix);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_apple_dt_semantic_mask", contract->apple_dt_semantic_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_platform_props", contract->platform_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_interrupt_props", contract->interrupt_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_timer_props", contract->timer_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_cpu_props", contract->cpu_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_rejected_props", contract->rejected_personality_prop_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_matched_mask", contract->matched_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_provider_published_mask", contract->provider_published_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_registry_linked_mask", contract->registry_linked_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_topology_linked_mask", contract->topology_linked_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_attach_readiness_mask", contract->attach_readiness_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_start_readiness_mask", contract->start_readiness_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_register_service_readiness_mask", contract->register_service_readiness_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_service_registered_mask", contract->service_registered_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_notification_ready_mask", contract->notification_ready_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_dependency_ready_mask", contract->dependency_ready_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_lifecycle_provenance_match_mask", contract->lifecycle_provenance_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_register_runtime_blocked_mask", contract->register_runtime_blocked_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_notification_runtime_blocked_mask", contract->notification_runtime_blocked_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_register_order_match_mask", contract->register_order_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_notification_order_match_mask", contract->notification_order_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_provider_dependency_match_mask", contract->provider_dependency_match_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_register_provider_start_required_mask", contract->register_provider_start_required_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_register_provider_start_satisfied_mask", contract->register_provider_start_satisfied_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_selected_lifecycle_entry_mask", contract->selected_lifecycle_entry_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_rejected_lifecycle_mask", contract->rejected_lifecycle_mask);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_lifecycle_matrix", contract->lifecycle_matrix);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_register_order_checksum", contract->register_order_checksum);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_notification_order_checksum", contract->notification_order_checksum);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_path_hash", contract->lifecycle_path_hash);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_checksum", contract->lifecycle_checksum);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_expected_checksum", contract->expected_lifecycle_checksum);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_candidate_count", contract->lifecycle_candidate_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_selected_entry_count", contract->selected_lifecycle_entry_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_rejected_entry_count", contract->rejected_lifecycle_entry_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_register_service_readiness_count", contract->register_service_readiness_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_service_registered_count", contract->service_registered_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_notification_ready_count", contract->notification_ready_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_dependency_ready_count", contract->dependency_ready_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_rejected_unregistered_count", contract->rejected_unregistered_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_public_compile_count", contract->iokit_public_compile_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_public_link_count", contract->iokit_public_link_count);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_no_iokit_runtime_exec", contract->no_iokit_runtime_exec);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_no_register_service_runtime_exec", contract->no_register_service_runtime_exec);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_no_notification_runtime_exec", contract->no_notification_runtime_exec);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_no_live_pmap_tables_installed", contract->no_live_pmap_tables_installed);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_proposed_workspace_written", contract->proposed_workspace_written);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_pmap_ttbr_written", contract->pmap_ttbr_written);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_pmap_tlbs_invalidated", contract->pmap_tlbs_invalidated);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_caches_changed", contract->caches_changed);
    xnu_log_kv32("stage88_xnu_iokit_lifecycle_register_service_persistent_write_attempted", contract->persistent_write_attempted);
}
...
static void selected_masks_for_node(const struct boot_args *args, const void *node, uint32_t bit,
                                    ...
                                    struct stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract *contract)
{
    ...
    if (string_prop_equals(args, node, "lifecycle-provenance", "stage88-attach-start-readiness")) {
...
int stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract_selftest(
    const struct stage88_loader_preflight *preflight)
{
    ...
    contract->version = STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_CONTRACT_VERSION;
    contract->size = sizeof(*contract);
    contract->status = STAGE88_STATUS_BASE;
    contract->required_mask = STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_REQUIRED_MASK;

    if (!preflight || !args || !root) {
        contract->failure_mask = STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_SOURCE |
            STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_SAFETY_BOUNDARY;
        contract->checksum = stage88_iokit_lifecycle_register_service_dryrun_checksum(contract);
        stage88_iokit_lifecycle_register_service_dryrun_log(contract);
        return 0;
    }
    ...
    selected_masks_for_node(args, platform_node, STAGE88_XNU_IOKIT_REGISTRY_SERVICE_PLATFORM_BIT,
                            ...
                            STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL, 0u, contract);
    selected_masks_for_node(args, interrupt_node, STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT,
                            ...
                            STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_INTERRUPT_ORDINAL, 1u, contract);
    selected_masks_for_node(args, timer_node, STAGE88_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT,
                            "IODeviceTree:/stage88-platform-personality",
                            STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL,
                            STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_TIMER_ORDINAL, 1u, contract);
    selected_masks_for_node(args, cpu_node, STAGE88_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT,
                            "IODeviceTree:/stage88-platform-personality",
                            STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_PLATFORM_ORDINAL,
                            STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_CPU_ORDINAL, 1u, contract);
    ...
    if (u32_prop_equals(args, rejected_node, "provider-plane-published", 0u) &&
        ...
        u32_prop_equals(args, rejected_node, "register-service-order", STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "notification-order", STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) &&
        u32_prop_equals(args, rejected_node, "register-dependency-ready", 0u) &&
        string_prop_equals(args, rejected_node, "lifecycle-provenance", "stage88-rejected-unregistered") &&
        u32_prop_equals(args, rejected_node, "rejected-candidate", 1u) &&
        u32_prop_equals(args, rejected_node, "stage-owned-local-only", 1u)) {
        contract->rejected_lifecycle_mask |= STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_BIT;
    }
    ...
    contract->lifecycle_path_hash = STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_PATH_HASH;
    contract->lifecycle_candidate_count = STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_CANDIDATE_COUNT;
    contract->selected_lifecycle_entry_count = (contract->selected_lifecycle_entry_mask ==
        ...
        STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_ENTRY_COUNT : 0u;
    contract->rejected_lifecycle_entry_count = (contract->rejected_lifecycle_mask ==
        ...
        STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_REJECTED_COUNT : 0u;
    ...
    contract->register_provider_required_count =
        (contract->register_provider_start_required_mask == (STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT |
                                                             STAGE88_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT |
                                                             STAGE88_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT)) ? 3u : 0u;
    contract->register_provider_satisfied_count =
        ((contract->register_provider_start_satisfied_mask & (STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT |
                                                              STAGE88_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT |
    ...
    contract->expected_lifecycle_checksum = STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_EXPECTED_CHECKSUM;
    ...
    source_ok = (contract->source_attach_start_status == STAGE88_STATUS_OK &&
                 contract->source_attach_start_satisfied_mask ==
                 STAGE88_XNU_IOKIT_ATTACH_START_READINESS_DRYRUN_REQUIRED_MASK &&
                 contract->source_attach_start_failure_mask == 0u &&
                 contract->source_attach_start_checksum == STAGE88_XNU_IOKIT_ATTACH_START_READINESS_EXPECTED_CHECKSUM &&
                 contract->source_selected_attach_start_entry_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_rejected_attach_start_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
                 contract->source_attach_start_matrix == (STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                                          STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) &&
                 contract->source_attach_readiness_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                 contract->source_start_readiness_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
    ...
    if (source_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_SOURCE_ATTACH_START;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_SOURCE;
    }

    if (contract->apple_dt_semantic_mask == STAGE88_DT_READY_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_APPLE_DT;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_DT;
    }
    ...
    if (personality_nodes_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_PERSONALITY_NODE_SET;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_PERSONALITY;
    }

    if (contract->matched_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_MATCHED_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_LIFECYCLE;
    }
    if (contract->provider_published_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_PROVIDER_PUBLISHED_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_LIFECYCLE;
    }
    if (contract->registry_linked_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_REGISTRY_LINKED_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_LIFECYCLE;
    }
    if (contract->topology_linked_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_TOPOLOGY_LINKED_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_LIFECYCLE;
    }
    if (contract->attach_readiness_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->start_readiness_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->source_selected_attach_start_entry_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_ATTACH_START_SOURCE_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_SOURCE;
    }
    if (contract->register_service_readiness_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_REGISTER_SERVICE_READINESS;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_REGISTER_SERVICE;
    }
    if (contract->service_registered_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_SERVICE_REGISTERED;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_REGISTER_SERVICE;
    }
    if (contract->notification_ready_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NOTIFICATION_READY;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_NOTIFICATION;
    }

    order_ok = (contract->register_order_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                contract->notification_order_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                contract->register_order_checksum == STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL &&
                contract->notification_order_checksum == STAGE88_XNU_IOKIT_REGISTRY_TOPOLOGY_REJECTED_ORDINAL) ? 1u : 0u;
    if (order_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_ORDER_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_ORDER_DEPENDENCY;
    }

    dependency_ok = (contract->dependency_ready_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                     contract->provider_dependency_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
                     contract->register_provider_start_required_mask == (STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT |
                                                                         STAGE88_XNU_IOKIT_REGISTRY_SERVICE_TIMER_BIT |
                                                                         STAGE88_XNU_IOKIT_REGISTRY_SERVICE_CPU_BIT) &&
                     contract->register_provider_start_satisfied_mask == (STAGE88_XNU_IOKIT_REGISTRY_SERVICE_INTERRUPT_BIT |
    ...
    if (dependency_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_PROVIDER_DEPENDENCY;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_ORDER_DEPENDENCY;
    }

    if (contract->register_runtime_blocked_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->notification_runtime_blocked_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_RUNTIME_BLOCKED;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_REGISTER_SERVICE |
            STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_NOTIFICATION;
    }
    if (contract->lifecycle_provenance_match_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_PROVENANCE;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_LIFECYCLE;
    }
    if (contract->selected_lifecycle_entry_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_SELECTED_LIFECYCLE_MATRIX;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_LIFECYCLE;
    }
    if (contract->rejected_lifecycle_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->source_rejected_attach_start_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED &&
        contract->rejected_unregistered_count == STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_REJECTED_COUNT) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_REJECT_UNREGISTERED;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_REJECTED;
    }
    if (contract->lifecycle_candidate_count == STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_CANDIDATE_COUNT &&
        contract->selected_lifecycle_entry_count == STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_ENTRY_COUNT &&
        contract->rejected_lifecycle_entry_count == STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_REJECTED_COUNT &&
        contract->register_service_readiness_count == STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_ENTRY_COUNT &&
        contract->service_registered_count == STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_ENTRY_COUNT &&
        contract->notification_ready_count == STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_ENTRY_COUNT &&
        contract->dependency_ready_count == STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_ENTRY_COUNT &&
        contract->lifecycle_matrix == (STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED |
                                       STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED)) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_DRYRUN_COUNTS;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_COUNTS;
    }
    if (contract->lifecycle_checksum == contract->expected_lifecycle_checksum) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_LIFECYCLE_CHECKSUM;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_CHECKSUM;
    }
    ...
    if (contract->iokit_reference_mask == STAGE88_XNU_IOKIT_REFERENCE_REQUIRED &&
        ...
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_IOKIT_REFERENCE;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }
    ...
    if (public_boundary_ok) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_PUBLIC_BOUNDARY |
            STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NO_IOKIT_RUNTIME_EXEC |
            STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NO_REGISTER_SERVICE_RUNTIME_EXEC |
            STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NO_NOTIFICATION_RUNTIME_EXEC |
            STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NO_PUBLIC_XNU_EXEC;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_PUBLIC_BOUNDARY;
    }

    if (contract->no_public_pmap_exec == 1u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NO_PUBLIC_PMAP_EXEC;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_PMAP_BOUNDARY;
    }
    ...
    if (contract->no_live_pmap_tables_installed == 0u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NO_LIVE_PMAP_INSTALL;
    }
    if (contract->pmap_tlbs_invalidated == 0u && contract->caches_changed == 0u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NO_TLB_CACHE_CHANGE;
    }
    if (pmap_boundary_ok && contract->source_pmap_transition_status == STAGE88_STATUS_OK) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_PMAP_BOUNDARY;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_PMAP_BOUNDARY;
    }

    if (contract->generated_macho_executed == 0u && contract->xnu_start_executed == 0u) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_NO_XNU_MACHO_EXEC;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }
    if (contract->local_only == 1u && contract->fail_closed == 1u &&
        ...
        contract->selected_lifecycle_entry_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_SELECTED_REQUIRED &&
        contract->rejected_lifecycle_mask == STAGE88_XNU_IOKIT_REGISTRY_SERVICE_REJECTED_REQUIRED) {
        contract->satisfied_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_SAT_LOCAL_ONLY_FAIL_CLOSED;
    } else {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_ROLLUP |
            STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_SAFETY_BOUNDARY;
    }

    contract->checksum = stage88_iokit_lifecycle_register_service_dryrun_checksum(contract);
    if (contract->checksum != stage88_iokit_lifecycle_register_service_dryrun_checksum(contract)) {
        contract->failure_mask |= STAGE88_XNU_IOKIT_LIFECYCLE_REGISTER_SERVICE_DRYRUN_FAIL_CHECKSUM;
    }
...
const struct stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract *
stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract_result(void)
{
    return &g_stage88_xnu_iokit_lifecycle_register_service_readiness_dryrun_contract;
}
