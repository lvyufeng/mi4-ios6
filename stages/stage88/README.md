...
- **Status**: `loader_status=0x88000001` (OK)
- **IRQ window status**: `stage88_xnu_arm_vm_init_irq_window_status=0x88000001` (OK)
...
```bash
cd /mnt/data/mi4-ios6/stage88
./build.sh
```

Artifacts:
- `out/stage88/stage88.elf` (507KB)
- `out/stage88/stage88.bin` (454KB)
- `out/stage88/stage88-qcdt.img` (2.9MB, includes QCDT device tree)
...
sudo adb -s 4a2fe00b exec-out 'cat /proc/last_kmsg' > /tmp/stage88-last_kmsg.txt
```

Expected pass markers:
```
stage88_xnu_arm_vm_init_irq_window_status=0x88000001
stage88_xnu_arm_vm_init_irq_window_satisfied_mask=0x00003fff
stage88_xnu_arm_vm_init_irq_window_failure_mask=0x00000000
stage88_xnu_arm_vm_init_irq_window_gic_configured=0x00000001
stage88_xnu_arm_vm_init_irq_window_timer_configured=0x00000001
stage88_xnu_arm_vm_init_irq_window_irq_enabled=0x00000001
stage88_xnu_arm_vm_init_irq_window_timer_irq_delivered=0x00000001
stage88_xnu_arm_vm_init_irq_window_irq_handled=0x00000001
...
- Planning: `docs/stage88-sgi-irq-timer-planning.md`
- Hardware validation: `docs/experiment-87-stage88-sgi-irq-timer.md` (to be created)
