...
- **Status**: `loader_status=0x85000001` (OK)
- **IRQ window status**: `stage85_xnu_arm_vm_init_irq_window_status=0x85000001` (OK)
...
```bash
cd /mnt/data/mi4-ios6/stage85
./build.sh
```

Artifacts:
- `out/stage85/stage85.elf` (507KB)
- `out/stage85/stage85.bin` (454KB)
- `out/stage85/stage85-qcdt.img` (2.9MB, includes QCDT device tree)
...
```
stage85_xnu_arm_vm_init_irq_window_status=0x85000001
stage85_xnu_arm_vm_init_irq_window_satisfied_mask=0x00003fff
stage85_xnu_arm_vm_init_irq_window_failure_mask=0x00000000
stage85_xnu_arm_vm_init_irq_window_gic_configured=0x00000001
stage85_xnu_arm_vm_init_irq_window_timer_configured=0x00000001
stage85_xnu_arm_vm_init_irq_window_irq_enabled=0x00000001
stage85_xnu_arm_vm_init_irq_window_timer_irq_delivered=0x00000001
stage85_xnu_arm_vm_init_irq_window_irq_handled=0x00000001
...
- Planning: `docs/stage85-sgi-irq-timer-planning.md`
- Hardware validation: `docs/experiment-87-stage85-sgi-irq-timer.md` (to be created)
