#ifndef MI4IOS6_STAGE11_H
#define MI4IOS6_STAGE11_H

#include <stdint.h>
#include <stddef.h>

#define STAGE11_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage11;
...
extern struct gic_state_snapshot GIC_state_stage11;
extern volatile uint32_t stage11_irq_count;
extern volatile uint32_t stage11_last_iar;
extern volatile uint32_t stage11_last_irq_id;
extern volatile uint32_t stage11_timer_irq_count;
extern volatile uint32_t stage11_last_timer_irq_id;
...
/* stage11_main.c */
void stage11_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage11_image_end[];
extern uint8_t stage11_vectors[];
void trigger_stage11_undef_test(void) __attribute__((noreturn));
void trigger_stage11_data_abort_test(void) __attribute__((noreturn));
