#ifndef MI4IOS6_STAGE9_H
#define MI4IOS6_STAGE9_H

#include <stdint.h>
#include <stddef.h>

#define STAGE9_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage9;
...
extern struct gic_state_snapshot GIC_state_stage9;
extern volatile uint32_t stage9_irq_count;
extern volatile uint32_t stage9_last_iar;
extern volatile uint32_t stage9_last_irq_id;
extern volatile uint32_t stage9_timer_irq_count;
extern volatile uint32_t stage9_last_timer_irq_id;
...
/* stage9_main.c */
void stage9_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage9_image_end[];
extern uint8_t stage9_vectors[];
void trigger_stage9_undef_test(void) __attribute__((noreturn));
void trigger_stage9_data_abort_test(void) __attribute__((noreturn));
