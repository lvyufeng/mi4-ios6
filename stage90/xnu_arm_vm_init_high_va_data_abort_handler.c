...
static struct stage90_xnu_arm_vm_init_high_va_data_abort_handler_result g_result;

static uint32_t stage90_xnu_arm_vm_init_high_va_data_abort_handler_checksum(
    volatile const struct stage90_xnu_arm_vm_init_high_va_data_abort_handler_result *r)
{
	volatile const uint32_t *words = (volatile const uint32_t *)r;
	uint32_t count = (uint32_t)(offsetof(struct stage90_xnu_arm_vm_init_high_va_data_abort_handler_result, checksum) / sizeof(uint32_t));
	uint32_t chk = 0;
...
static void stage90_xnu_arm_vm_init_high_va_data_abort_handler_log(
    volatile const struct stage90_xnu_arm_vm_init_high_va_data_abort_handler_result *r)
{
	xnu_log_puts("stage90_xnu_arm_vm_init_high_va_data_abort_handler result:\n");
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_version", r->version);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_size", r->size);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_status", r->status);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_required_mask", r->required_mask);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_satisfied_mask", r->satisfied_mask);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_failure_mask", r->failure_mask);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_full_pmap_status", r->full_pmap_status);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_vectors_phys", r->vectors_phys);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_vectors_high_va", r->vectors_high_va);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_original_vbar", r->original_vbar);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_high_va_vbar_set", r->high_va_vbar_set);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_abort_triggered", r->abort_triggered);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_abort_handled", r->abort_handled);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_dfar", r->dfar);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_dfar_expected", r->dfar_expected);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_dfar_correct", r->dfar_correct);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_dfsr", r->dfsr);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_dfsr_valid", r->dfsr_valid);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_vbar_restored", r->vbar_restored);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_restored_vbar", r->restored_vbar);
	xnu_log_kv32("stage90_xnu_arm_vm_init_high_va_data_abort_handler_checksum", r->checksum);
}
...
void stage90_data_abort_c_handler(uint32_t *stack_ptr)
{
	...
	if (g_abort_count < 4) {
		log_puts("MI4IOS6_STAGE90 data abort: dfar=");
		log_hex32(dfar);
		log_puts(" dfsr=");
		log_hex32(dfsr);
		log_puts(" lr=");
...
int stage90_xnu_arm_vm_init_high_va_data_abort_handler_run(
    struct boot_args *args,
    struct stage90_xnu_entry_stub_result *entry_result)
{
	struct stage90_xnu_arm_vm_init_high_va_data_abort_handler_result *r = &g_result;
	...
	/* Initialize result */
	memset(r, 0, sizeof(*r));
	r->version = STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_VERSION;
	r->size = sizeof(*r);
	r->required_mask = STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_REQUIRED_MASK;
	...
	if (!pmap_result || pmap_result->status != STAGE90_STATUS_OK) {
		r->failure_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_FAIL_FULL_PMAP;
		goto finish;
	}
	r->full_pmap_status = pmap_result->status;
	r->satisfied_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_SAT_FULL_PMAP_OK;
	...
	r->satisfied_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_SAT_VBAR_SET;
	...
	r->abort_triggered = 1;
	r->satisfied_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_SAT_ABORT_TRIGGERED;

	/* Verify abort was handled */
	if (g_abort_handled) {
		r->abort_handled = 1;
		r->satisfied_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_SAT_ABORT_HANDLED;
	} else {
		r->failure_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_FAIL_ABORT_NOT_HANDLED;
	}
	...
	if (g_abort_dfar == 0xdeadc000) {
		r->dfar_correct = 1;
		r->satisfied_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_SAT_DFAR_CORRECT;
	}
	...
	if (dfsr_status == 0x1u || dfsr_status == 0x5u || dfsr_status == 0x7u) {
		r->dfsr_valid = 1;
		r->satisfied_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_SAT_DFSR_VALID;
	}
	...
	r->satisfied_mask |= STAGE90_XNU_ARM_VM_INIT_HIGH_VA_DATA_ABORT_HANDLER_SAT_VBAR_RESTORED;
...
finish:
	...
	/* Compute checksum */
	r->checksum = stage90_xnu_arm_vm_init_high_va_data_abort_handler_checksum(r);

	/* Log result */
	stage90_xnu_arm_vm_init_high_va_data_abort_handler_log(r);

	return r->status == STAGE90_STATUS_OK ? 0 : -1;
}

const struct stage90_xnu_arm_vm_init_high_va_data_abort_handler_result *
stage90_xnu_arm_vm_init_high_va_data_abort_handler_result(void)
{
	return &g_result;
}
