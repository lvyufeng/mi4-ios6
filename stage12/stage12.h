#ifndef MI4IOS6_STAGE12_H
#define MI4IOS6_STAGE12_H

#include <stdint.h>
#include <stddef.h>

#define STAGE12_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage12;
...
extern struct gic_state_snapshot GIC_state_stage12;
extern volatile uint32_t stage12_irq_count;
extern volatile uint32_t stage12_last_iar;
extern volatile uint32_t stage12_last_irq_id;
extern volatile uint32_t stage12_timer_irq_count;
extern volatile uint32_t stage12_last_timer_irq_id;
...
/* stage12_main.c */
void stage12_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage12_image_end[];
extern uint8_t stage12_vectors[];
void trigger_stage12_undef_test(void) __attribute__((noreturn));
void trigger_stage12_data_abort_test(void) __attribute__((noreturn));
