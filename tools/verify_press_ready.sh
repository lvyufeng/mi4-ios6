...
if [[ ! -x $ARM_CHECK ]]; then
  ...
  if [[ $wst =~ ^[1-9][0-9]*$ ]]; then
    ...
    if [[ $wst == 2 || $wst == 3 || $wst == 4 || $wst == 5 || $wst == 6 || $wst == 7 || $wst == 8 || $wst == 9 ]]; then
