...
## Stage80 Method-C status

The Stage76-Stage80 Method-C pivot has started exercising the public ARM boot-shape observations above on real `cancro` hardware without crossing into public XNU runtime:
