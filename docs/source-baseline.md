...
See also `docs/upstream-xnu-analysis.md`, `docs/experiment-79-stage76-live-xnu-like-execution-probe.md`, `docs/experiment-80-stage77-xnu-entry-stub.md`, `docs/experiment-81-stage78-early-pmap-platform-init.md`, `docs/experiment-82-stage79-pe-init-platform-false.md`, `docs/experiment-83-stage80-arm-init-post-pe-bootstrap.md`, and `docs/experiment-84-stage81-arm-vm-init-live-pmap.md` for the current live-execution pivot, plus the Stage50-Stage81 experiment documents for the preceding public-XNU workspace, object-subset, link-proof, bootstrap, pmap, pexpert, IOKit dry-run, and Method-C prerequisites.
