#ifndef MI4IOS6_STAGE32_H
#define MI4IOS6_STAGE32_H

#include <stdint.h>
#include <stddef.h>

#define STAGE32_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage32;
...
extern struct gic_state_snapshot GIC_state_stage32;
extern volatile uint32_t stage32_irq_count;
extern volatile uint32_t stage32_last_iar;
extern volatile uint32_t stage32_last_irq_id;
extern volatile uint32_t stage32_timer_irq_count;
extern volatile uint32_t stage32_last_timer_irq_id;
...
/* stage32_main.c */
void stage32_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage32_image_end[];
extern uint8_t stage32_vectors[];
void trigger_stage32_undef_test(void) __attribute__((noreturn));
void trigger_stage32_data_abort_test(void) __attribute__((noreturn));
