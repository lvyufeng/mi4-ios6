#ifndef MI4IOS6_STAGE18_H
#define MI4IOS6_STAGE18_H

#include <stdint.h>
#include <stddef.h>

#define STAGE18_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage18;
...
extern struct gic_state_snapshot GIC_state_stage18;
extern volatile uint32_t stage18_irq_count;
extern volatile uint32_t stage18_last_iar;
extern volatile uint32_t stage18_last_irq_id;
extern volatile uint32_t stage18_timer_irq_count;
extern volatile uint32_t stage18_last_timer_irq_id;
...
/* stage18_main.c */
void stage18_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage18_image_end[];
extern uint8_t stage18_vectors[];
void trigger_stage18_undef_test(void) __attribute__((noreturn));
void trigger_stage18_data_abort_test(void) __attribute__((noreturn));
