#ifndef MI4IOS6_STAGE10_H
#define MI4IOS6_STAGE10_H

#include <stdint.h>
#include <stddef.h>

#define STAGE10_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage10;
...
extern struct gic_state_snapshot GIC_state_stage10;
extern volatile uint32_t stage10_irq_count;
extern volatile uint32_t stage10_last_iar;
extern volatile uint32_t stage10_last_irq_id;
extern volatile uint32_t stage10_timer_irq_count;
extern volatile uint32_t stage10_last_timer_irq_id;
...
/* stage10_main.c */
void stage10_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage10_image_end[];
extern uint8_t stage10_vectors[];
void trigger_stage10_undef_test(void) __attribute__((noreturn));
void trigger_stage10_data_abort_test(void) __attribute__((noreturn));
