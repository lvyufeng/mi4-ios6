#ifndef MI4IOS6_STAGE36_H
#define MI4IOS6_STAGE36_H

#include <stdint.h>
#include <stddef.h>

#define STAGE36_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage36;
...
extern struct gic_state_snapshot GIC_state_stage36;
extern volatile uint32_t stage36_irq_count;
extern volatile uint32_t stage36_last_iar;
extern volatile uint32_t stage36_last_irq_id;
extern volatile uint32_t stage36_timer_irq_count;
extern volatile uint32_t stage36_last_timer_irq_id;
...
/* stage36_main.c */
void stage36_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage36_image_end[];
extern uint8_t stage36_vectors[];
void trigger_stage36_undef_test(void) __attribute__((noreturn));
void trigger_stage36_data_abort_test(void) __attribute__((noreturn));
