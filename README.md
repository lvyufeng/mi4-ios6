...
| `tools/` | Host-side helpers: `stage-archive.sh` for the archived stages, `decode_armv7_descriptor.py` for page-table entries, `check_boot_args_abi.py` for the XNU `boot_args` layout, and the boot-image and fixture generators. |
