...
- Expand from the Stage55 pexpert/platform compile graph toward additional tracked public-XNU pexpert/platform compile units, or refine the loader/mapping side, instead of jumping directly to a full kernel.
- Keep large source checkouts under ignored `external/` and build outputs under ignored `out/stage56/`.
