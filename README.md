...
Stage0 through Stage18 are complete. The next practical target is Stage19: let the high root build a versioned early platform-result object from high DT and PE_state facts.

Near-term Stage19 work:
