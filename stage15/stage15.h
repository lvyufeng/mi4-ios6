#ifndef MI4IOS6_STAGE15_H
#define MI4IOS6_STAGE15_H

#include <stdint.h>
#include <stddef.h>

#define STAGE15_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage15;
...
extern struct gic_state_snapshot GIC_state_stage15;
extern volatile uint32_t stage15_irq_count;
extern volatile uint32_t stage15_last_iar;
extern volatile uint32_t stage15_last_irq_id;
extern volatile uint32_t stage15_timer_irq_count;
extern volatile uint32_t stage15_last_timer_irq_id;
...
/* stage15_main.c */
void stage15_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage15_image_end[];
extern uint8_t stage15_vectors[];
void trigger_stage15_undef_test(void) __attribute__((noreturn));
void trigger_stage15_data_abort_test(void) __attribute__((noreturn));
