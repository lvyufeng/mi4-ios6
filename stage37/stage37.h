#ifndef MI4IOS6_STAGE37_H
#define MI4IOS6_STAGE37_H

#include <stdint.h>
#include <stddef.h>

#define STAGE37_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage37;
...
extern struct gic_state_snapshot GIC_state_stage37;
extern volatile uint32_t stage37_irq_count;
extern volatile uint32_t stage37_last_iar;
extern volatile uint32_t stage37_last_irq_id;
extern volatile uint32_t stage37_timer_irq_count;
extern volatile uint32_t stage37_last_timer_irq_id;
...
/* stage37_main.c */
void stage37_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage37_image_end[];
extern uint8_t stage37_vectors[];
void trigger_stage37_undef_test(void) __attribute__((noreturn));
void trigger_stage37_data_abort_test(void) __attribute__((noreturn));
