#ifndef MI4IOS6_STAGE34_H
#define MI4IOS6_STAGE34_H

#include <stdint.h>
#include <stddef.h>

#define STAGE34_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage34;
...
extern struct gic_state_snapshot GIC_state_stage34;
extern volatile uint32_t stage34_irq_count;
extern volatile uint32_t stage34_last_iar;
extern volatile uint32_t stage34_last_irq_id;
extern volatile uint32_t stage34_timer_irq_count;
extern volatile uint32_t stage34_last_timer_irq_id;
...
/* stage34_main.c */
void stage34_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage34_image_end[];
extern uint8_t stage34_vectors[];
void trigger_stage34_undef_test(void) __attribute__((noreturn));
void trigger_stage34_data_abort_test(void) __attribute__((noreturn));
