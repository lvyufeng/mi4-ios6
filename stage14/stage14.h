#ifndef MI4IOS6_STAGE14_H
#define MI4IOS6_STAGE14_H

#include <stdint.h>
#include <stddef.h>

#define STAGE14_BASE          0x00008000u
...
extern struct pe_platform_state PE_state_stage14;
...
extern struct gic_state_snapshot GIC_state_stage14;
extern volatile uint32_t stage14_irq_count;
extern volatile uint32_t stage14_last_iar;
extern volatile uint32_t stage14_last_irq_id;
extern volatile uint32_t stage14_timer_irq_count;
extern volatile uint32_t stage14_last_timer_irq_id;
...
/* stage14_main.c */
void stage14_main(void) __attribute__((noreturn));
void platform_reboot(void) __attribute__((noreturn));
int test_kernel_entry(struct boot_args *args);

extern uint8_t __stage14_image_end[];
extern uint8_t stage14_vectors[];
void trigger_stage14_undef_test(void) __attribute__((noreturn));
void trigger_stage14_data_abort_test(void) __attribute__((noreturn));
